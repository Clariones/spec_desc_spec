...
<div style="display: block;margin-bottom: 10px;padding-bottom: 5px;box-shadow: 0px 10px 10px lightgray;">
	<div class="menu">
		[<a href="wxappService/viewHomePage/">首页</a>]
		[<a href="clientService/customerViewDashboard/">我的</a>]
		<span style="padding: 0px 20px">|</span>

		[<a href="clientService/logout/">登出</a>]
...
function mobileVcodeLogin() {
	var url = "wxappService/loginForTest/formData/";
    	var formData = {
