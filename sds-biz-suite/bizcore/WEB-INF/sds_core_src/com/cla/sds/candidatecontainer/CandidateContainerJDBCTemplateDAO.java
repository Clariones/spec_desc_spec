...
public class CandidateContainerJDBCTemplateDAO extends SdsBaseDAOImpl implements CandidateContainerDAO{
	...
	*/
    ...
    public SmartList<CandidateContainer> requestCandidateCandidateContainerForCandidateElement(SdsUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
	...
	public SmartList<CandidateElement> loadOurCandidateElementList(SdsUserContext userContext, List<CandidateContainer> us, Map<String,Object> options) throws Exception{
