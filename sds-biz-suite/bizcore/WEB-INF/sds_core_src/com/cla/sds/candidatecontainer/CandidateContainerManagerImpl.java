...
public class CandidateContainerManagerImpl extends CustomSdsCheckerManager implements CandidateContainerManager, BusinessHandler{
	...
	@Override
	public CandidateContainerDAO daoOf(SdsUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws CandidateContainerManagerException{
 	...
 	protected CandidateContainer saveCandidateContainer(SdsUserContext userContext, CandidateContainer candidateContainer, String [] tokensExpr) throws Exception{	
 	...
 	protected CandidateContainer saveCandidateContainerDetail(SdsUserContext userContext, CandidateContainer candidateContainer) throws Exception{	
 	...
 	public CandidateContainer loadCandidateContainer(SdsUserContext userContext, String candidateContainerId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public CandidateContainer searchCandidateContainer(SdsUserContext userContext, String candidateContainerId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected CandidateContainer present(SdsUserContext userContext, CandidateContainer candidateContainer, Map<String, Object> tokens) throws Exception {
 	...
 	public CandidateContainer loadCandidateContainerDetail(SdsUserContext userContext, String candidateContainerId) throws Exception{	
 	...
 	public Object view(SdsUserContext userContext, String candidateContainerId) throws Exception{	
 		CandidateContainer candidateContainer = loadCandidateContainer( userContext, candidateContainerId, viewTokens());
 		return present(userContext,candidateContainer, allTokens());
		
 	}
 	protected CandidateContainer saveCandidateContainer(SdsUserContext userContext, CandidateContainer candidateContainer, Map<String,Object>tokens) throws Exception{	
 		return candidateContainerDaoOf(userContext).save(candidateContainer, tokens);
 	}
 	protected CandidateContainer loadCandidateContainer(SdsUserContext userContext, String candidateContainerId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfCandidateContainer(candidateContainerId);
		checkerOf(userContext).throwExceptionIfHasErrors( CandidateContainerManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(SdsUserContext userContext, CandidateContainer candidateContainer, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(SdsUserContext userContext, CandidateContainer candidateContainer, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingCandidateContainer(SdsUserContext userContext,String candidateContainerId, int candidateContainerVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public CandidateContainer clone(SdsUserContext userContext, String fromCandidateContainerId) throws Exception{
	...
	public CandidateContainer internalSaveCandidateContainer(SdsUserContext userContext, CandidateContainer candidateContainer, Map<String,Object> options) throws Exception
	{
	...
	public CandidateContainer updateCandidateContainerProperty(SdsUserContext userContext,String candidateContainerId, int candidateContainerVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingCandidateContainer(userContext, candidateContainerId, candidateContainerVersion, property, newValueExpr, tokensExpr);
...
//--------------------------------------------------------------
	...
	public void delete(SdsUserContext userContext, String candidateContainerId, int candidateContainerVersion) throws Exception {
	...
	public CandidateContainer forgetByAll(SdsUserContext userContext, String candidateContainerId, int candidateContainerVersion) throws Exception {
		return forgetByAllInternal(userContext, candidateContainerId, candidateContainerVersion);
	}
	protected CandidateContainer forgetByAllInternal(SdsUserContext userContext,
			String candidateContainerId, int candidateContainerVersion) throws Exception{
	...
	protected void checkParamsForAddingCandidateElement(SdsUserContext userContext, String candidateContainerId, String name, String type, String image,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingCandidateElementProperties(SdsUserContext userContext, String candidateContainerId,String id,String name,String type,String image,String [] tokensExpr) throws Exception {
	...
	public  CandidateContainer updateCandidateElementProperties(SdsUserContext userContext, String candidateContainerId, String id,String name,String type,String image, String [] tokensExpr) throws Exception
	{
	...
	protected CandidateElement createCandidateElement(SdsUserContext userContext, String name, String type, String image) throws Exception{
	...
	protected void checkParamsForRemovingCandidateElementList(SdsUserContext userContext, String candidateContainerId,
	...
	public  CandidateContainer removeCandidateElementList(SdsUserContext userContext, String candidateContainerId,
			String candidateElementIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingCandidateElement(SdsUserContext userContext, String candidateContainerId,
	...
	public  CandidateContainer removeCandidateElement(SdsUserContext userContext, String candidateContainerId,
		String candidateElementId, int candidateElementVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingCandidateElement(SdsUserContext userContext, String candidateContainerId,
		String candidateElementId, int candidateElementVersion,String [] tokensExpr) throws Exception{
	...
	public  CandidateContainer copyCandidateElementFrom(SdsUserContext userContext, String candidateContainerId,
		String candidateElementId, int candidateElementVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingCandidateElement(SdsUserContext userContext, String candidateContainerId, String candidateElementId, int candidateElementVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  CandidateContainer updateCandidateElement(SdsUserContext userContext, String candidateContainerId, String candidateElementId, int candidateElementVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(SdsUserContext userContext,SmartList<CandidateContainer> list) throws Exception {
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(SdsUserContext userContext, String candidateContainerId) throws Exception{
	  SerializeScope vscope = SdsViewScope.getInstance().getCandidateContainerDetailScope().clone();
    ...
    String pageTitle = "候选人容器"+"详情";
		...
		vscope.field("candidateElementListSection", SdsListOfViewScope.getInstance()
