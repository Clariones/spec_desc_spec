...
public class PageTypeManagerImpl extends CustomSdsCheckerManager implements PageTypeManager, BusinessHandler{
	...
	@Override
	public PageTypeDAO daoOf(SdsUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws PageTypeManagerException{
 	...
 	protected PageType savePageType(SdsUserContext userContext, PageType pageType, String [] tokensExpr) throws Exception{	
 	...
 	protected PageType savePageTypeDetail(SdsUserContext userContext, PageType pageType) throws Exception{	
 	...
 	public PageType loadPageType(SdsUserContext userContext, String pageTypeId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public PageType searchPageType(SdsUserContext userContext, String pageTypeId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected PageType present(SdsUserContext userContext, PageType pageType, Map<String, Object> tokens) throws Exception {
 	...
 	public PageType loadPageTypeDetail(SdsUserContext userContext, String pageTypeId) throws Exception{	
 		PageType pageType = loadPageType( userContext, pageTypeId, allTokens());
 		return present(userContext,pageType, allTokens());
		
 	}
 	
 	public Object view(SdsUserContext userContext, String pageTypeId) throws Exception{	
 		PageType pageType = loadPageType( userContext, pageTypeId, viewTokens());
 		return present(userContext,pageType, allTokens());
		
 	}
 	protected PageType savePageType(SdsUserContext userContext, PageType pageType, Map<String,Object>tokens) throws Exception{	
 		return pageTypeDaoOf(userContext).save(pageType, tokens);
 	}
 	protected PageType loadPageType(SdsUserContext userContext, String pageTypeId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfPageType(pageTypeId);
		checkerOf(userContext).throwExceptionIfHasErrors( PageTypeManagerException.class);
	...
	public PageType loadPageTypeWithCode(SdsUserContext userContext, String code, Map<String,Object>tokens) throws Exception{	
 	...
 	protected<T extends BaseEntity> void addActions(SdsUserContext userContext, PageType pageType, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(SdsUserContext userContext, PageType pageType, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingPageType(SdsUserContext userContext,String pageTypeId, int pageTypeVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public PageType clone(SdsUserContext userContext, String fromPageTypeId) throws Exception{
	...
	public PageType internalSavePageType(SdsUserContext userContext, PageType pageType, Map<String,Object> options) throws Exception
	{
	...
	public PageType updatePageTypeProperty(SdsUserContext userContext,String pageTypeId, int pageTypeVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingPageType(userContext, pageTypeId, pageTypeVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherMobileApp(SdsUserContext userContext, String pageTypeId, String anotherMobileAppId) throws Exception
 	{
 ...
 //--------------------------------------------------------------
	...
	public void delete(SdsUserContext userContext, String pageTypeId, int pageTypeVersion) throws Exception {
	...
	public PageType forgetByAll(SdsUserContext userContext, String pageTypeId, int pageTypeVersion) throws Exception {
		return forgetByAllInternal(userContext, pageTypeId, pageTypeVersion);
	}
	protected PageType forgetByAllInternal(SdsUserContext userContext,
			String pageTypeId, int pageTypeVersion) throws Exception{
	...
	protected PageType breakWithPageByMobileApp(SdsUserContext userContext, String pageTypeId, String mobileAppId,  String [] tokensExpr)
		 throws Exception{
	...
	protected void checkParamsForAddingPage(SdsUserContext userContext, String pageTypeId, String pageTitle, String linkToUrl, int displayOrder, String mobileAppId,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingPageProperties(SdsUserContext userContext, String pageTypeId,String id,String pageTitle,String linkToUrl,int displayOrder,String [] tokensExpr) throws Exception {
	...
	public  PageType updatePageProperties(SdsUserContext userContext, String pageTypeId, String id,String pageTitle,String linkToUrl,int displayOrder, String [] tokensExpr) throws Exception
	{
	...
	protected Page createPage(SdsUserContext userContext, String pageTitle, String linkToUrl, int displayOrder, String mobileAppId) throws Exception{
	...
	protected void checkParamsForRemovingPageList(SdsUserContext userContext, String pageTypeId,
	...
	public  PageType removePageList(SdsUserContext userContext, String pageTypeId,
			String pageIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingPage(SdsUserContext userContext, String pageTypeId,
	...
	public  PageType removePage(SdsUserContext userContext, String pageTypeId,
		String pageId, int pageVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingPage(SdsUserContext userContext, String pageTypeId,
		String pageId, int pageVersion,String [] tokensExpr) throws Exception{
	...
	public  PageType copyPageFrom(SdsUserContext userContext, String pageTypeId,
		String pageId, int pageVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingPage(SdsUserContext userContext, String pageTypeId, String pageId, int pageVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  PageType updatePage(SdsUserContext userContext, String pageTypeId, String pageId, int pageVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(SdsUserContext userContext,SmartList<PageType> list) throws Exception {
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(SdsUserContext userContext, String pageTypeId) throws Exception{
	  SerializeScope vscope = SdsViewScope.getInstance().getPageTypeDetailScope().clone();
