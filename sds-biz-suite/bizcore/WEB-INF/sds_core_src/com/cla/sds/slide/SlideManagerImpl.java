...
public class SlideManagerImpl extends CustomSdsCheckerManager implements SlideManager, BusinessHandler{
	...
	@Override
	public SlideDAO daoOf(SdsUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws SlideManagerException{
 	...
 	protected Slide saveSlide(SdsUserContext userContext, Slide slide, String [] tokensExpr) throws Exception{	
 	...
 	protected Slide saveSlideDetail(SdsUserContext userContext, Slide slide) throws Exception{	
 	...
 	public Slide loadSlide(SdsUserContext userContext, String slideId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public Slide searchSlide(SdsUserContext userContext, String slideId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected Slide present(SdsUserContext userContext, Slide slide, Map<String, Object> tokens) throws Exception {
 	...
 	public Slide loadSlideDetail(SdsUserContext userContext, String slideId) throws Exception{	
 		Slide slide = loadSlide( userContext, slideId, allTokens());
 		return present(userContext,slide, allTokens());
		
 	}
 	
 	public Object view(SdsUserContext userContext, String slideId) throws Exception{	
 		Slide slide = loadSlide( userContext, slideId, viewTokens());
 		return present(userContext,slide, allTokens());
		
 	}
 	protected Slide saveSlide(SdsUserContext userContext, Slide slide, Map<String,Object>tokens) throws Exception{	
 		return slideDaoOf(userContext).save(slide, tokens);
 	}
 	protected Slide loadSlide(SdsUserContext userContext, String slideId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfSlide(slideId);
		checkerOf(userContext).throwExceptionIfHasErrors( SlideManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(SdsUserContext userContext, Slide slide, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(SdsUserContext userContext, Slide slide, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingSlide(SdsUserContext userContext,String slideId, int slideVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public Slide clone(SdsUserContext userContext, String fromSlideId) throws Exception{
	...
	public Slide internalSaveSlide(SdsUserContext userContext, Slide slide, Map<String,Object> options) throws Exception
	{
	...
	public Slide updateSlideProperty(SdsUserContext userContext,String slideId, int slideVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingSlide(userContext, slideId, slideVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherPage(SdsUserContext userContext, String slideId, String anotherPageId) throws Exception
 	{
 ...
 //--------------------------------------------------------------
	...
	public void delete(SdsUserContext userContext, String slideId, int slideVersion) throws Exception {
	...
	public Slide forgetByAll(SdsUserContext userContext, String slideId, int slideVersion) throws Exception {
		return forgetByAllInternal(userContext, slideId, slideVersion);
	}
	protected Slide forgetByAllInternal(SdsUserContext userContext,
			String slideId, int slideVersion) throws Exception{
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(SdsUserContext userContext,SmartList<Slide> list) throws Exception {
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(SdsUserContext userContext, String slideId) throws Exception{
	  SerializeScope vscope = SdsViewScope.getInstance().getSlideDetailScope().clone();
