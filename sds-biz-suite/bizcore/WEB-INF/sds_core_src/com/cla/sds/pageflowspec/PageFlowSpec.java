...
@JsonSerialize(using = PageFlowSpecSerializer.class)
public class PageFlowSpec extends BaseEntity implements  java.io.Serializable{
	...
	public static final String INTERNAL_TYPE="PageFlowSpec";
	...
	public 	static PageFlowSpec withId(String id){
		PageFlowSpec pageFlowSpec = new PageFlowSpec();
		pageFlowSpec.setId(id);
		pageFlowSpec.setVersion(Integer.MAX_VALUE);
		return pageFlowSpec;
	}
	public 	static PageFlowSpec refById(String id){
		return withId(id);
	}
	...
	public PageFlowSpec updateId(String id){
		this.mId = trimString(id);;
		this.changed = true;
		return this;
	}
	...
	public PageFlowSpec updateScene(String scene){
		this.mScene = trimString(scene);;
		this.changed = true;
		return this;
	}
	...
	public PageFlowSpec updateBrief(String brief){
		this.mBrief = brief;;
		this.changed = true;
		return this;
	}
	...
	public PageFlowSpec updateOwner(User owner){
		this.mOwner = owner;;
		this.changed = true;
		return this;
	}
	...
	public PageFlowSpec updateProject(Project project){
		this.mProject = project;;
		this.changed = true;
		return this;
	}
	...
	public PageFlowSpec updateVersion(int version){
		this.mVersion = version;;
		this.changed = true;
		return this;
	}
	...
	public BaseEntity copyTo(BaseEntity baseDest){
		...
		if(baseDest instanceof PageFlowSpec){
		
		
			PageFlowSpec dest =(PageFlowSpec)baseDest;
	...
	public String toString(){
		...
		stringBuilder.append("PageFlowSpec{");
