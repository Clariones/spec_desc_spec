...
public class ChangeRequestTypeJDBCTemplateDAO extends SdsBaseDAOImpl implements ChangeRequestTypeDAO{
	...
	*/
    ...
    public SmartList<ChangeRequestType> requestCandidateChangeRequestTypeForChangeRequest(SdsUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
        // NOTE: by default, ignore owner info, just return all by filter key.
		// You need override this method if you have different candidate-logic
		return findAllCandidateByFilter(ChangeRequestTypeTable.COLUMN_NAME, ChangeRequestTypeTable.COLUMN_PLATFORM, filterKey, pageNo, pageSize, getChangeRequestTypeMapper());
    }
	...
	public SmartList<ChangeRequest> loadOurChangeRequestList(SdsUserContext userContext, List<ChangeRequestType> us, Map<String,Object> options) throws Exception{
	...
	@Override
	public CandidateChangeRequestType executeCandidatesQuery(CandidateQuery query, String sql, Object ... parmeters) throws Exception {
