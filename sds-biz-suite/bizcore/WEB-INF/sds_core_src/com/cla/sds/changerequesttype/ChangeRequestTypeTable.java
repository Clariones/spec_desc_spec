...
public class ChangeRequestTypeTable{
	...
	public static final String []ALL_CLOUMNS = {COLUMN_ID,COLUMN_NAME,COLUMN_CODE,COLUMN_ICON,COLUMN_DISPLAY_ORDER,COLUMN_BIND_TYPES,COLUMN_STEP_CONFIGURATION,COLUMN_PLATFORM,COLUMN_VERSION};
	public static final String []NORMAL_CLOUMNS = {COLUMN_NAME,COLUMN_CODE,COLUMN_ICON,COLUMN_DISPLAY_ORDER,COLUMN_BIND_TYPES,COLUMN_STEP_CONFIGURATION,COLUMN_PLATFORM};
