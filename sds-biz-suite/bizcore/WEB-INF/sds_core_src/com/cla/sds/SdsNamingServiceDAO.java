...
public class SdsNamingServiceDAO extends CommonJDBCTemplateDAO {
	...
	static {
		...
		namingTableMap.put("Company", new String[]{"company_data","name"});
		namingTableMap.put("User", new String[]{"user_data","name"});
		namingTableMap.put("UserProject", new String[]{"user_project_data","id"});
		...
		namingTableMap.put("EventUpdateProfile", new String[]{"event_update_profile_data","name"});
		namingTableMap.put("Project", new String[]{"project_data","name"});
		namingTableMap.put("PageFlowSpec", new String[]{"page_flow_spec_data","scene"});
		namingTableMap.put("WorkFlowSpec", new String[]{"work_flow_spec_data","scene"});
		namingTableMap.put("ChangeRequestSpec", new String[]{"change_request_spec_data","scene"});
		namingTableMap.put("PageContentSpec", new String[]{"page_content_spec_data","scene"});
