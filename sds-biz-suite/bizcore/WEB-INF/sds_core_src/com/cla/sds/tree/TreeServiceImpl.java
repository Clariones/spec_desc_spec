...
public class TreeServiceImpl extends CustomSdsCheckerManager implements TreeService {

    @Override
    public Node loadTree(SdsUserContext ctx, String nodeId, String nodeType) throws Exception {
    ...
    @Override
    public Node loadAncestors(SdsUserContext ctx, String nodeId, String nodeType) throws Exception {
        SmartList<TreeNode> nodes = loadTreeNode(ctx, nodeId, nodeType);
    ...
    public SmartList<TreeNode> loadTreeNode(SdsUserContext ctx, String nodeId, String nodeType) {
     ...
     * @throws Exception
     */
    private <T extends BaseEntity> Node<T> extractTreeFromRoot(SdsUserContext ctx, TreeNode pRoot) throws Exception {
    ...
    private <T extends BaseEntity> Node<T> extractAncestors(SdsUserContext ctx, TreeNode pNode) throws Exception {
    ...
    @Override
    public Node addChild(SdsUserContext ctx, Node nodeTree, String childId, String childType) throws Exception {
    ...
    public Node ensureRoot(SdsUserContext ctx) throws Exception {
    ...
    @Override
    public Node deleteChild(SdsUserContext ctx, Node parent, Node child) throws Exception {
        //do nothing
    ...
    private Node buildInternalTree(SdsUserContext ctx, final List<TreeNode> pTreeNodes) throws Exception {
