...
@JsonSerialize(using = ChangeRequestSpecSerializer.class)
public class ChangeRequestSpec extends BaseEntity implements  java.io.Serializable{
	...
	public static final String INTERNAL_TYPE="ChangeRequestSpec";
	...
	public 	ChangeRequestSpec(){
		// lazy load for all the properties
	}
	public 	static ChangeRequestSpec withId(String id){
		ChangeRequestSpec changeRequestSpec = new ChangeRequestSpec();
		changeRequestSpec.setId(id);
		changeRequestSpec.setVersion(Integer.MAX_VALUE);
		return changeRequestSpec;
	}
	public 	static ChangeRequestSpec refById(String id){
		return withId(id);
	}
	...
	public ChangeRequestSpec updateId(String id){
		this.mId = trimString(id);;
		this.changed = true;
		return this;
	}
	...
	public ChangeRequestSpec updateScene(String scene){
		this.mScene = trimString(scene);;
		this.changed = true;
		return this;
	}
	...
	public ChangeRequestSpec updateBrief(String brief){
		this.mBrief = brief;;
		this.changed = true;
		return this;
	}
	...
	public ChangeRequestSpec updateOwner(User owner){
		this.mOwner = owner;;
		this.changed = true;
		return this;
	}
	...
	public ChangeRequestSpec updateProject(Project project){
		this.mProject = project;;
		this.changed = true;
		return this;
	}
	...
	public ChangeRequestSpec updateVersion(int version){
		this.mVersion = version;;
		this.changed = true;
		return this;
	}
	...
	public BaseEntity copyTo(BaseEntity baseDest){
		...
		if(baseDest instanceof ChangeRequestSpec){
		
		
			ChangeRequestSpec dest =(ChangeRequestSpec)baseDest;
	...
	public String toString(){
		...
		stringBuilder.append("ChangeRequestSpec{");
