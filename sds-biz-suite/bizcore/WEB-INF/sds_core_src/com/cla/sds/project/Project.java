...
public class Project extends BaseEntity implements  java.io.Serializable{
	...
	public static final String INTERNAL_TYPE="Project";
	...
	public 	static Project withId(String id){
		Project project = new Project();
		project.setId(id);
		project.setVersion(Integer.MAX_VALUE);
		return project;
	}
	public 	static Project refById(String id){
		return withId(id);
	}
	...
	public Project updateId(String id){
		this.mId = trimString(id);;
		this.changed = true;
		return this;
	}
	...
	public Project updateVersion(int version){
		this.mVersion = version;;
		this.changed = true;
		return this;
	}
	...
	public  UserProject removeUserProject(UserProject userProjectIndex){
        ...
        // userProject.clearProject(); //disconnect with Project
        userProject.clearFromAll(); //disconnect with Project
	...
	public  PageFlowSpec removePageFlowSpec(PageFlowSpec pageFlowSpecIndex){
        ...
        // pageFlowSpec.clearProject(); //disconnect with Project
        pageFlowSpec.clearFromAll(); //disconnect with Project
	...
	public  WorkFlowSpec removeWorkFlowSpec(WorkFlowSpec workFlowSpecIndex){
        ...
        // workFlowSpec.clearProject(); //disconnect with Project
        workFlowSpec.clearFromAll(); //disconnect with Project
	...
	public  void setChangeRequestSpecList(SmartList<ChangeRequestSpec> changeRequestSpecList){
		for( ChangeRequestSpec changeRequestSpec:changeRequestSpecList){
			changeRequestSpec.setProject(this);
		}
	...
	public  ChangeRequestSpec removeChangeRequestSpec(ChangeRequestSpec changeRequestSpecIndex){
        ...
        // changeRequestSpec.clearProject(); //disconnect with Project
        changeRequestSpec.clearFromAll(); //disconnect with Project
	...
	public  void breakWithChangeRequestSpec(ChangeRequestSpec changeRequestSpec){
		...
		changeRequestSpec.setProject(null);
	...
	public  void setPageContentSpecList(SmartList<PageContentSpec> pageContentSpecList){
		for( PageContentSpec pageContentSpec:pageContentSpecList){
			pageContentSpec.setProject(this);
		}
	...
	public  PageContentSpec removePageContentSpec(PageContentSpec pageContentSpecIndex){
        ...
        // pageContentSpec.clearProject(); //disconnect with Project
        pageContentSpec.clearFromAll(); //disconnect with Project
	...
	public  void breakWithPageContentSpec(PageContentSpec pageContentSpec){
		...
		pageContentSpec.setProject(null);
	...
	public BaseEntity copyTo(BaseEntity baseDest){
		...
		if(baseDest instanceof Project){
		
		
			Project dest =(Project)baseDest;
	...
	public Object[] toFlatArray(){
		return new Object[]{getId(), getName(), getCompany(), getVersion()};
	}
