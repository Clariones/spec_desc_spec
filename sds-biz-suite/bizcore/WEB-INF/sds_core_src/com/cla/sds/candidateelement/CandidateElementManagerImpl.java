...
import com.cla.sds.candidatecontainer.CandidateCandidateContainer;
...
public class CandidateElementManagerImpl extends CustomSdsCheckerManager implements CandidateElementManager, BusinessHandler{
	...
	@Override
	public CandidateElementDAO daoOf(SdsUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws CandidateElementManagerException{
 	...
 	protected CandidateElement saveCandidateElement(SdsUserContext userContext, CandidateElement candidateElement, String [] tokensExpr) throws Exception{	
 	...
 	protected CandidateElement saveCandidateElementDetail(SdsUserContext userContext, CandidateElement candidateElement) throws Exception{	
 	...
 	public CandidateElement loadCandidateElement(SdsUserContext userContext, String candidateElementId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public CandidateElement searchCandidateElement(SdsUserContext userContext, String candidateElementId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected CandidateElement present(SdsUserContext userContext, CandidateElement candidateElement, Map<String, Object> tokens) throws Exception {
 	...
 	public CandidateElement loadCandidateElementDetail(SdsUserContext userContext, String candidateElementId) throws Exception{	
 	...
 	public Object view(SdsUserContext userContext, String candidateElementId) throws Exception{	
 		CandidateElement candidateElement = loadCandidateElement( userContext, candidateElementId, viewTokens());
 		return present(userContext,candidateElement, allTokens());
		
 	}
 	protected CandidateElement saveCandidateElement(SdsUserContext userContext, CandidateElement candidateElement, Map<String,Object>tokens) throws Exception{	
 		return candidateElementDaoOf(userContext).save(candidateElement, tokens);
 	}
 	protected CandidateElement loadCandidateElement(SdsUserContext userContext, String candidateElementId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfCandidateElement(candidateElementId);
		checkerOf(userContext).throwExceptionIfHasErrors( CandidateElementManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(SdsUserContext userContext, CandidateElement candidateElement, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(SdsUserContext userContext, CandidateElement candidateElement, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingCandidateElement(SdsUserContext userContext,String candidateElementId, int candidateElementVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public CandidateElement clone(SdsUserContext userContext, String fromCandidateElementId) throws Exception{
	...
	public CandidateElement internalSaveCandidateElement(SdsUserContext userContext, CandidateElement candidateElement, Map<String,Object> options) throws Exception
	{
	...
	public CandidateElement updateCandidateElementProperty(SdsUserContext userContext,String candidateElementId, int candidateElementVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingCandidateElement(userContext, candidateElementId, candidateElementVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherContainer(SdsUserContext userContext, String candidateElementId, String anotherContainerId) throws Exception
 	{
	...
	public CandidateCandidateContainer requestCandidateContainer(SdsUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 ...
 //--------------------------------------------------------------
 	...
 	protected CandidateContainer loadCandidateContainer(SdsUserContext userContext, String newContainerId, Map<String,Object> options) throws Exception
 	{
	...
	public void delete(SdsUserContext userContext, String candidateElementId, int candidateElementVersion) throws Exception {
	...
	public CandidateElement forgetByAll(SdsUserContext userContext, String candidateElementId, int candidateElementVersion) throws Exception {
		return forgetByAllInternal(userContext, candidateElementId, candidateElementVersion);
	}
	protected CandidateElement forgetByAllInternal(SdsUserContext userContext,
			String candidateElementId, int candidateElementVersion) throws Exception{
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(SdsUserContext userContext,SmartList<CandidateElement> list) throws Exception {
    	if (list == null || list.isEmpty()){
    		return;
    	}
		List<CandidateContainer> containerList = SdsBaseUtils.collectReferencedObjectWithType(userContext, list, CandidateContainer.class);
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(SdsUserContext userContext, String candidateElementId) throws Exception{
	  SerializeScope vscope = SdsViewScope.getInstance().getCandidateElementDetailScope().clone();
