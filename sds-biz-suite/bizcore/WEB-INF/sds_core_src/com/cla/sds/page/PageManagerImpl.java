...
import com.cla.sds.mobileapp.CandidateMobileApp;
import com.cla.sds.pagetype.CandidatePageType;
...
public class PageManagerImpl extends CustomSdsCheckerManager implements PageManager, BusinessHandler{
	...
	@Override
	public PageDAO daoOf(SdsUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws PageManagerException{
 	...
 	protected Page savePage(SdsUserContext userContext, Page page, String [] tokensExpr) throws Exception{	
 	...
 	protected Page savePageDetail(SdsUserContext userContext, Page page) throws Exception{	
 	...
 	public Page loadPage(SdsUserContext userContext, String pageId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public Page searchPage(SdsUserContext userContext, String pageId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected Page present(SdsUserContext userContext, Page page, Map<String, Object> tokens) throws Exception {
 	...
 	public Page loadPageDetail(SdsUserContext userContext, String pageId) throws Exception{	
 		Page page = loadPage( userContext, pageId, allTokens());
 		return present(userContext,page, allTokens());
		
 	}
 	
 	public Object view(SdsUserContext userContext, String pageId) throws Exception{	
 		Page page = loadPage( userContext, pageId, viewTokens());
 		return present(userContext,page, allTokens());
		
 	}
 	protected Page savePage(SdsUserContext userContext, Page page, Map<String,Object>tokens) throws Exception{	
 		return pageDaoOf(userContext).save(page, tokens);
 	}
 	protected Page loadPage(SdsUserContext userContext, String pageId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfPage(pageId);
		checkerOf(userContext).throwExceptionIfHasErrors( PageManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(SdsUserContext userContext, Page page, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(SdsUserContext userContext, Page page, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingPage(SdsUserContext userContext,String pageId, int pageVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public Page clone(SdsUserContext userContext, String fromPageId) throws Exception{
	...
	public Page internalSavePage(SdsUserContext userContext, Page page, Map<String,Object> options) throws Exception
	{
	...
	public Page updatePageProperty(SdsUserContext userContext,String pageId, int pageVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingPage(userContext, pageId, pageVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherPageType(SdsUserContext userContext, String pageId, String anotherPageTypeId) throws Exception
 	{
	...
	protected void checkParamsForTransferingAnotherPageTypeWithCode(SdsUserContext userContext, String pageId, String anotherCode) throws Exception
 	{
 	...
 	public Page transferToAnotherPageTypeWithCode(SdsUserContext userContext, String pageId, String anotherCode) throws Exception
 	{
	...
	public CandidatePageType requestCandidatePageType(SdsUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 	...
 	protected void checkParamsForTransferingAnotherMobileApp(SdsUserContext userContext, String pageId, String anotherMobileAppId) throws Exception
 	{
	...
	public CandidateMobileApp requestCandidateMobileApp(SdsUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 ...
 //--------------------------------------------------------------
 	...
 	protected PageType loadPageType(SdsUserContext userContext, String newPageTypeId, Map<String,Object> options) throws Exception
 	{

 		return pageTypeDaoOf(userContext).load(newPageTypeId, options);
 	}
 	
 	protected PageType loadPageTypeWithCode(SdsUserContext userContext, String newCode, Map<String,Object> options) throws Exception
 	{
 	...
 	protected MobileApp loadMobileApp(SdsUserContext userContext, String newMobileAppId, Map<String,Object> options) throws Exception
 	{
	...
	public void delete(SdsUserContext userContext, String pageId, int pageVersion) throws Exception {
	...
	public Page forgetByAll(SdsUserContext userContext, String pageId, int pageVersion) throws Exception {
		return forgetByAllInternal(userContext, pageId, pageVersion);
	}
	protected Page forgetByAllInternal(SdsUserContext userContext,
			String pageId, int pageVersion) throws Exception{
	...
	protected void checkParamsForAddingSlide(SdsUserContext userContext, String pageId, String name, int displayOrder, String imageUrl, String videoUrl, String linkToUrl,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingSlideProperties(SdsUserContext userContext, String pageId,String id,String name,int displayOrder,String imageUrl,String videoUrl,String linkToUrl,String [] tokensExpr) throws Exception {
	...
	public  Page updateSlideProperties(SdsUserContext userContext, String pageId, String id,String name,int displayOrder,String imageUrl,String videoUrl,String linkToUrl, String [] tokensExpr) throws Exception
	{
	...
	protected Slide createSlide(SdsUserContext userContext, String name, int displayOrder, String imageUrl, String videoUrl, String linkToUrl) throws Exception{
	...
	protected void checkParamsForRemovingSlideList(SdsUserContext userContext, String pageId,
	...
	public  Page removeSlideList(SdsUserContext userContext, String pageId,
			String slideIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingSlide(SdsUserContext userContext, String pageId,
	...
	public  Page removeSlide(SdsUserContext userContext, String pageId,
		String slideId, int slideVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingSlide(SdsUserContext userContext, String pageId,
		String slideId, int slideVersion,String [] tokensExpr) throws Exception{
	...
	public  Page copySlideFrom(SdsUserContext userContext, String pageId,
		String slideId, int slideVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingSlide(SdsUserContext userContext, String pageId, String slideId, int slideVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  Page updateSlide(SdsUserContext userContext, String pageId, String slideId, int slideVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	protected void checkParamsForAddingUiAction(SdsUserContext userContext, String pageId, String code, String icon, String title, int displayOrder, String brief, String imageUrl, String linkToUrl, String extraData,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingUiActionProperties(SdsUserContext userContext, String pageId,String id,String code,String icon,String title,int displayOrder,String brief,String imageUrl,String linkToUrl,String extraData,String [] tokensExpr) throws Exception {
	...
	public  Page updateUiActionProperties(SdsUserContext userContext, String pageId, String id,String code,String icon,String title,int displayOrder,String brief,String imageUrl,String linkToUrl,String extraData, String [] tokensExpr) throws Exception
	{
	...
	protected UiAction createUiAction(SdsUserContext userContext, String code, String icon, String title, int displayOrder, String brief, String imageUrl, String linkToUrl, String extraData) throws Exception{
	...
	protected void checkParamsForRemovingUiActionList(SdsUserContext userContext, String pageId,
	...
	public  Page removeUiActionList(SdsUserContext userContext, String pageId,
			String uiActionIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingUiAction(SdsUserContext userContext, String pageId,
	...
	public  Page removeUiAction(SdsUserContext userContext, String pageId,
		String uiActionId, int uiActionVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingUiAction(SdsUserContext userContext, String pageId,
		String uiActionId, int uiActionVersion,String [] tokensExpr) throws Exception{
	...
	public  Page copyUiActionFrom(SdsUserContext userContext, String pageId,
		String uiActionId, int uiActionVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingUiAction(SdsUserContext userContext, String pageId, String uiActionId, int uiActionVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  Page updateUiAction(SdsUserContext userContext, String pageId, String uiActionId, int uiActionVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	protected void checkParamsForAddingSection(SdsUserContext userContext, String pageId, String title, String brief, String icon, int displayOrder, String viewGroup, String linkToUrl,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingSectionProperties(SdsUserContext userContext, String pageId,String id,String title,String brief,String icon,int displayOrder,String viewGroup,String linkToUrl,String [] tokensExpr) throws Exception {
	...
	public  Page updateSectionProperties(SdsUserContext userContext, String pageId, String id,String title,String brief,String icon,int displayOrder,String viewGroup,String linkToUrl, String [] tokensExpr) throws Exception
	{
	...
	protected Section createSection(SdsUserContext userContext, String title, String brief, String icon, int displayOrder, String viewGroup, String linkToUrl) throws Exception{
	...
	protected void checkParamsForRemovingSectionList(SdsUserContext userContext, String pageId,
	...
	public  Page removeSectionList(SdsUserContext userContext, String pageId,
			String sectionIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingSection(SdsUserContext userContext, String pageId,
	...
	public  Page removeSection(SdsUserContext userContext, String pageId,
		String sectionId, int sectionVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingSection(SdsUserContext userContext, String pageId,
		String sectionId, int sectionVersion,String [] tokensExpr) throws Exception{
	...
	public  Page copySectionFrom(SdsUserContext userContext, String pageId,
		String sectionId, int sectionVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingSection(SdsUserContext userContext, String pageId, String sectionId, int sectionVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  Page updateSection(SdsUserContext userContext, String pageId, String sectionId, int sectionVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(SdsUserContext userContext,SmartList<Page> list) throws Exception {
    	if (list == null || list.isEmpty()){
    		return;
    	}
		List<PageType> pageTypeList = SdsBaseUtils.collectReferencedObjectWithType(userContext, list, PageType.class);
		userContext.getDAOGroup().enhanceList(pageTypeList, PageType.class);
		List<MobileApp> mobileAppList = SdsBaseUtils.collectReferencedObjectWithType(userContext, list, MobileApp.class);
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(SdsUserContext userContext, String pageId) throws Exception{
    ...
    String pageTitle = "页面"+"详情";
		...
		vscope.field("slideListSection", SdsListOfViewScope.getInstance()
		...
		vscope.field("uiActionListSection", SdsListOfViewScope.getInstance()
		...
		vscope.field("sectionListSection", SdsListOfViewScope.getInstance()
