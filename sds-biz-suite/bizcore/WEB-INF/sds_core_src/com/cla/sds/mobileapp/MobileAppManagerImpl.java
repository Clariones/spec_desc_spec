...
public class MobileAppManagerImpl extends CustomSdsCheckerManager implements MobileAppManager, BusinessHandler{
	...
	@Override
	public MobileAppDAO daoOf(SdsUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws MobileAppManagerException{
 	...
 	protected MobileApp saveMobileApp(SdsUserContext userContext, MobileApp mobileApp, String [] tokensExpr) throws Exception{	
 	...
 	protected MobileApp saveMobileAppDetail(SdsUserContext userContext, MobileApp mobileApp) throws Exception{	
 	...
 	public MobileApp loadMobileApp(SdsUserContext userContext, String mobileAppId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public MobileApp searchMobileApp(SdsUserContext userContext, String mobileAppId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected MobileApp present(SdsUserContext userContext, MobileApp mobileApp, Map<String, Object> tokens) throws Exception {
 	...
 	public MobileApp loadMobileAppDetail(SdsUserContext userContext, String mobileAppId) throws Exception{	
 		MobileApp mobileApp = loadMobileApp( userContext, mobileAppId, allTokens());
 		return present(userContext,mobileApp, allTokens());
		
 	}
 	
 	public Object view(SdsUserContext userContext, String mobileAppId) throws Exception{	
 		MobileApp mobileApp = loadMobileApp( userContext, mobileAppId, viewTokens());
 		return present(userContext,mobileApp, allTokens());
		
 	}
 	protected MobileApp saveMobileApp(SdsUserContext userContext, MobileApp mobileApp, Map<String,Object>tokens) throws Exception{	
 		return mobileAppDaoOf(userContext).save(mobileApp, tokens);
 	}
 	protected MobileApp loadMobileApp(SdsUserContext userContext, String mobileAppId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfMobileApp(mobileAppId);
		checkerOf(userContext).throwExceptionIfHasErrors( MobileAppManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(SdsUserContext userContext, MobileApp mobileApp, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(SdsUserContext userContext, MobileApp mobileApp, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingMobileApp(SdsUserContext userContext,String mobileAppId, int mobileAppVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public MobileApp clone(SdsUserContext userContext, String fromMobileAppId) throws Exception{
	...
	public MobileApp internalSaveMobileApp(SdsUserContext userContext, MobileApp mobileApp, Map<String,Object> options) throws Exception
	{
	...
	public MobileApp updateMobileAppProperty(SdsUserContext userContext,String mobileAppId, int mobileAppVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingMobileApp(userContext, mobileAppId, mobileAppVersion, property, newValueExpr, tokensExpr);
...
//--------------------------------------------------------------
	...
	public void delete(SdsUserContext userContext, String mobileAppId, int mobileAppVersion) throws Exception {
	...
	public MobileApp forgetByAll(SdsUserContext userContext, String mobileAppId, int mobileAppVersion) throws Exception {
		return forgetByAllInternal(userContext, mobileAppId, mobileAppVersion);
	}
	protected MobileApp forgetByAllInternal(SdsUserContext userContext,
			String mobileAppId, int mobileAppVersion) throws Exception{
	...
	protected MobileApp breakWithPageByPageType(SdsUserContext userContext, String mobileAppId, String pageTypeId,  String [] tokensExpr)
		 throws Exception{
	...
	protected void checkParamsForAddingPage(SdsUserContext userContext, String mobileAppId, String pageTitle, String linkToUrl, String pageTypeId, int displayOrder,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingPageProperties(SdsUserContext userContext, String mobileAppId,String id,String pageTitle,String linkToUrl,int displayOrder,String [] tokensExpr) throws Exception {
	...
	public  MobileApp updatePageProperties(SdsUserContext userContext, String mobileAppId, String id,String pageTitle,String linkToUrl,int displayOrder, String [] tokensExpr) throws Exception
	{
	...
	protected Page createPage(SdsUserContext userContext, String pageTitle, String linkToUrl, String pageTypeId, int displayOrder) throws Exception{
	...
	protected void checkParamsForRemovingPageList(SdsUserContext userContext, String mobileAppId,
	...
	public  MobileApp removePageList(SdsUserContext userContext, String mobileAppId,
			String pageIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingPage(SdsUserContext userContext, String mobileAppId,
	...
	public  MobileApp removePage(SdsUserContext userContext, String mobileAppId,
		String pageId, int pageVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingPage(SdsUserContext userContext, String mobileAppId,
		String pageId, int pageVersion,String [] tokensExpr) throws Exception{
	...
	public  MobileApp copyPageFrom(SdsUserContext userContext, String mobileAppId,
		String pageId, int pageVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingPage(SdsUserContext userContext, String mobileAppId, String pageId, int pageVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  MobileApp updatePage(SdsUserContext userContext, String mobileAppId, String pageId, int pageVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	protected void checkParamsForAddingPageType(SdsUserContext userContext, String mobileAppId, String name, String code, boolean footerTab,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingPageTypeProperties(SdsUserContext userContext, String mobileAppId,String id,String name,String code,boolean footerTab,String [] tokensExpr) throws Exception {
	...
	public  MobileApp updatePageTypeProperties(SdsUserContext userContext, String mobileAppId, String id,String name,String code,boolean footerTab, String [] tokensExpr) throws Exception
	{
	...
	protected PageType createPageType(SdsUserContext userContext, String name, String code, boolean footerTab) throws Exception{
	...
	protected void checkParamsForRemovingPageTypeList(SdsUserContext userContext, String mobileAppId,
	...
	public  MobileApp removePageTypeList(SdsUserContext userContext, String mobileAppId,
			String pageTypeIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingPageType(SdsUserContext userContext, String mobileAppId,
	...
	public  MobileApp removePageType(SdsUserContext userContext, String mobileAppId,
		String pageTypeId, int pageTypeVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingPageType(SdsUserContext userContext, String mobileAppId,
		String pageTypeId, int pageTypeVersion,String [] tokensExpr) throws Exception{
	...
	public  MobileApp copyPageTypeFrom(SdsUserContext userContext, String mobileAppId,
		String pageTypeId, int pageTypeVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingPageType(SdsUserContext userContext, String mobileAppId, String pageTypeId, int pageTypeVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  MobileApp updatePageType(SdsUserContext userContext, String mobileAppId, String pageTypeId, int pageTypeVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(SdsUserContext userContext,SmartList<MobileApp> list) throws Exception {
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(SdsUserContext userContext, String mobileAppId) throws Exception{
	  SerializeScope vscope = SdsViewScope.getInstance().getMobileAppDetailScope().clone();
    ...
    String pageTitle = "手机应用程序"+"详情";
		...
		vscope.field("pageListSection", SdsListOfViewScope.getInstance()
