...
public class MobileAppJDBCTemplateDAO extends SdsBaseDAOImpl implements MobileAppDAO{
	...
	*/
    ...
    public SmartList<MobileApp> requestCandidateMobileAppForPage(SdsUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
    ...
    public SmartList<MobileApp> requestCandidateMobileAppForPageType(SdsUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
        // NOTE: by default, ignore owner info, just return all by filter key.
		// You need override this method if you have different candidate-logic
		return findAllCandidateByFilter(MobileAppTable.COLUMN_NAME, null, filterKey, pageNo, pageSize, getMobileAppMapper());
    }
	...
	public SmartList<Page> loadOurPageList(SdsUserContext userContext, List<MobileApp> us, Map<String,Object> options) throws Exception{
	...
	public SmartList<PageType> loadOurPageTypeList(SdsUserContext userContext, List<MobileApp> us, Map<String,Object> options) throws Exception{
		if (us == null || us.isEmpty()){
			return new SmartList<>();
		}
		Set<String> ids = us.stream().map(it->it.getId()).collect(Collectors.toSet());
