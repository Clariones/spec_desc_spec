...
public class TreeNodeManagerImpl extends CustomSdsCheckerManager implements TreeNodeManager, BusinessHandler{
	...
	@Override
	public TreeNodeDAO daoOf(SdsUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws TreeNodeManagerException{
 	...
 	protected TreeNode saveTreeNode(SdsUserContext userContext, TreeNode treeNode, String [] tokensExpr) throws Exception{	
 	...
 	protected TreeNode saveTreeNodeDetail(SdsUserContext userContext, TreeNode treeNode) throws Exception{	
 	...
 	public TreeNode loadTreeNode(SdsUserContext userContext, String treeNodeId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public TreeNode searchTreeNode(SdsUserContext userContext, String treeNodeId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected TreeNode present(SdsUserContext userContext, TreeNode treeNode, Map<String, Object> tokens) throws Exception {
 	...
 	public TreeNode loadTreeNodeDetail(SdsUserContext userContext, String treeNodeId) throws Exception{	
 		TreeNode treeNode = loadTreeNode( userContext, treeNodeId, allTokens());
 		return present(userContext,treeNode, allTokens());
		
 	}
 	
 	public Object view(SdsUserContext userContext, String treeNodeId) throws Exception{	
 		TreeNode treeNode = loadTreeNode( userContext, treeNodeId, viewTokens());
 		return present(userContext,treeNode, allTokens());
		
 	}
 	protected TreeNode saveTreeNode(SdsUserContext userContext, TreeNode treeNode, Map<String,Object>tokens) throws Exception{	
 		return treeNodeDaoOf(userContext).save(treeNode, tokens);
 	}
 	protected TreeNode loadTreeNode(SdsUserContext userContext, String treeNodeId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfTreeNode(treeNodeId);
		checkerOf(userContext).throwExceptionIfHasErrors( TreeNodeManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(SdsUserContext userContext, TreeNode treeNode, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(SdsUserContext userContext, TreeNode treeNode, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingTreeNode(SdsUserContext userContext,String treeNodeId, int treeNodeVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public TreeNode clone(SdsUserContext userContext, String fromTreeNodeId) throws Exception{
	...
	public TreeNode internalSaveTreeNode(SdsUserContext userContext, TreeNode treeNode, Map<String,Object> options) throws Exception
	{
	...
	public TreeNode updateTreeNodeProperty(SdsUserContext userContext,String treeNodeId, int treeNodeVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingTreeNode(userContext, treeNodeId, treeNodeVersion, property, newValueExpr, tokensExpr);
...
//--------------------------------------------------------------
	...
	public void delete(SdsUserContext userContext, String treeNodeId, int treeNodeVersion) throws Exception {
	...
	public TreeNode forgetByAll(SdsUserContext userContext, String treeNodeId, int treeNodeVersion) throws Exception {
		return forgetByAllInternal(userContext, treeNodeId, treeNodeVersion);
	}
	protected TreeNode forgetByAllInternal(SdsUserContext userContext,
			String treeNodeId, int treeNodeVersion) throws Exception{
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(SdsUserContext userContext,SmartList<TreeNode> list) throws Exception {
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(SdsUserContext userContext, String treeNodeId) throws Exception{
	  SerializeScope vscope = SdsViewScope.getInstance().getTreeNodeDetailScope().clone();
