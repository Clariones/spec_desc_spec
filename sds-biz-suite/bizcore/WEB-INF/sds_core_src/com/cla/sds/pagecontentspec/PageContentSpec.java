...
@JsonSerialize(using = PageContentSpecSerializer.class)
public class PageContentSpec extends BaseEntity implements  java.io.Serializable{
	...
	public static final String INTERNAL_TYPE="PageContentSpec";
	...
	public 	PageContentSpec(){
		// lazy load for all the properties
	}
	public 	static PageContentSpec withId(String id){
		PageContentSpec pageContentSpec = new PageContentSpec();
		pageContentSpec.setId(id);
		pageContentSpec.setVersion(Integer.MAX_VALUE);
		return pageContentSpec;
	}
	public 	static PageContentSpec refById(String id){
		return withId(id);
	}
	...
	public PageContentSpec updateId(String id){
		this.mId = trimString(id);;
		this.changed = true;
		return this;
	}
	...
	public PageContentSpec updateScene(String scene){
		this.mScene = trimString(scene);;
		this.changed = true;
		return this;
	}
	...
	public PageContentSpec updateBrief(String brief){
		this.mBrief = brief;;
		this.changed = true;
		return this;
	}
	...
	public PageContentSpec updateOwner(User owner){
		this.mOwner = owner;;
		this.changed = true;
		return this;
	}
	...
	public PageContentSpec updateProject(Project project){
		this.mProject = project;;
		this.changed = true;
		return this;
	}
	...
	public PageContentSpec updateVersion(int version){
		this.mVersion = version;;
		this.changed = true;
		return this;
	}
	...
	public BaseEntity copyTo(BaseEntity baseDest){
		...
		if(baseDest instanceof PageContentSpec){
		
		
			PageContentSpec dest =(PageContentSpec)baseDest;
	...
	public String toString(){
		...
		stringBuilder.append("PageContentSpec{");
