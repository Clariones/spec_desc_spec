...
import com.cla.sds.secuser.SecUserCustomManagerImpl;
import com.cla.sds.userapp.UserApp;
import com.cla.sds.userapp.UserAppTokens;
import com.terapico.utils.CollectionUtils;

public class SdsUserContextImpl extends UserContextImpl implements SdsUserContext{
	...
	static final String RESOURCE_PATH="com.cla.sds.SdsResources";
	static final String CUSTOM_RESOURCE_PATH="com.cla.sds.SdsCustomResources";
    ...
    /*
    public static SecUser getSecUser(SdsUserContext userContext) {
	...
	public static UserApp getSingleUserAppByObjectName(SdsUserContext userContext, String objectName)
			throws Exception {
		SecUserCustomManagerImpl secUserManager = (SecUserCustomManagerImpl) userContext.getManagerGroup()
				.getSecUserManager();
		SecUser secUser = secUserManager.getCachedSecUser(userContext);
	...
	*/
	public static SmartList<UserApp> getUserAppByName(SdsUserContext userContext, SecUser secUser, String objectName) {
	...
	public static UserApp getUserAppByBindedEntity(SdsUserContext userContext, BaseEntity userAppBindedObject) {
		MultipleAccessKey key = new MultipleAccessKey();
	...
	private SdsObjectChecker checker;
