...
public class WechatMiniprogramHandler extends BaseIdentificationHandler {
	...
	@Override
	public LoginResult authenticate(SdsUserContext userContext, LoginContext loginContext) {
	...
	protected boolean authenticateWithCode(SdsUserContext userContext, String code, LoginResult result) throws Exception{
	...
	@Override
	public void bindWithSecUser(SdsUserContext userContext, LoginContext loginContext) throws Exception {
	...
	protected SmartList<WechatMiniappIdentity> getIdentifyRecords(SdsUserContext userContext,
