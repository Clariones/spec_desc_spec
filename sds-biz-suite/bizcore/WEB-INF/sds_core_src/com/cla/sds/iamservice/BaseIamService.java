...
import com.cla.sds.UserContext;
...
public abstract class BaseIamService {
	...
	public LoginResult doLogin(SdsUserContextImpl userContext, LoginContext loginContext, BusinessHandler bizHandler) throws Exception {
  ...
  public Object doLogout(SdsUserContextImpl userContext, BusinessHandler bizHandler) throws Exception {
		// 回调业务
	 ...
	 * @throws Exception
	 */
	protected void onAuthenticateNewUserLogged(SdsUserContextImpl userContext, LoginContext loginContext,
	 ...
	 *
	 */
	protected void onAuthenticateUserLogged(SdsUserContextImpl userContext, LoginContext loginContext,
			LoginResult loginResult, IdentificationHandler idHandler, BusinessHandler bizHandler) throws Exception {
		// 回调业务
	...
	// 为兼容旧版本secUser登录接口
	public void onLoginSecUserInternalSuccess(SdsUserContextImpl userContext, SecUser user) {
		String tokenKey = userContext.tokenId();
		// 生成 jwtToken
	 ...
	 */
	protected boolean isLoginClientSupportSession(SdsUserContextImpl userContext, LoginContext loginContext,
	 ...
	 */
	protected void onAuthenticationFailed(SdsUserContextImpl userContext, LoginContext loginContext, LoginResult loginResult,
	 ...
	 * @return
	 */
	protected IdentificationHandler selectIdentificationHandler(SdsUserContextImpl userContext, LoginContext loginContext) {
		if (idHandlers == null) {
	...
	protected String getLoginInfoCacheKey(SdsUserContextImpl userContext) {
		return this.getCacheKey(userContext, "loginInfo");
	}
	protected String getJwtTokenCacheKey(SdsUserContextImpl userContext) {
		return this.getCacheKey(userContext, "jwtToken");
	}

	// 获取token key的优先级为: jwtToken->cookie->session id
	public String getTokenKey(SdsUserContextImpl userContext) {
	...
	protected void cacheJwtToken(SdsUserContextImpl userContext, DecodedJWT jwtToken) {
		userContext.putIntoContextLocalStorage(getJwtTokenCacheKey(userContext), jwtToken);
	}
	protected DecodedJWT getCachedJwtToken(SdsUserContextImpl userContext) {
		return (DecodedJWT) userContext.getFromContextLocalStorage(getJwtTokenCacheKey(userContext));
	}

	protected DecodedJWT getJwtTokenFromCookie(SdsUserContextImpl userContext) {
	...
	protected DecodedJWT getJwtTokenFromHeader(SdsUserContextImpl userContext) {
	...
	public Map<String, Object> getCachedLoginInfo(SdsUserContextImpl userContext) {
		getTokenKey(userContext);
		String cacheKey = getLoginInfoCacheKey(userContext);
	...
	protected String getCacheKey(UserContext userContext, String prefix){
		return "sds:"+prefix+":"+userContext.tokenId();
	}
	protected String getUserKey(UserContext userContext){
		return "sds:user:"+userContext.tokenId();
	}
	protected String getCurrentAppKey(UserContext userContext){
		return getUserKey(userContext)+":currentApp";
	}
	protected void fixUserContextTokenId(SdsUserContextImpl userContext, String tokenKey) {
		if (!userContext.tokenId().equals(tokenKey)) {
			userContext.setTokenId(tokenKey);
		}
	}
	public SecUser tryToLoadSecUser(SdsUserContextImpl userContext, Map<String, Object> loginInfo){
		if(loginInfo == null) {
			return null;
		}
	...
	public UserApp tryToLoadUserApp(SdsUserContextImpl userContext, Map<String, Object> loginInfo){
		if(loginInfo == null) {
			return null;
		}
	 ...
	 * @param loginInfo2 */
	public void onCheckAccessWhenAnonymousFound(SdsUserContextImpl userContext, Map<String, Object> loginInfo) {
...
//
//
//	protected boolean onSecUserNotFoundWhenCheckAccess(SdsUserContextImpl userContext, Map<String, Object> loginInfo,
//			SecUser secUser, UserApp userApp) {
//		return false;
//	}
//	protected boolean onSecUserFoundWhenCheckAccess(SdsUserContextImpl userContext, Map<String, Object> loginInfo,
//			SecUser secUser, UserApp userApp) {
//		return true;
//	}
//	protected boolean onSecUserAppFoundWhenCheckAccess(SdsUserContextImpl userContext, Map<String, Object> loginInfo,
//			SecUser secUser, UserApp userApp) {
//		return true;
//	}
//	protected SecUser tryToLoadSecUser(SdsUserContextImpl userContext, Map<String, Object> loginInfo){
//		if(loginInfo == null) {
//			return null;
//		}
//		String secUserId = (String) loginInfo.get("secUser");
...
//		}
//	}
//	protected UserApp tryToLoadUserApp(SdsUserContextImpl userContext, Map<String, Object> loginInfo){
//		if(loginInfo == null) {
//			return null;
//		}
//
...
//
//
//	public Object exampleLoginByAccountPassword(SdsUserContextImpl userContext, String acct, String password) throws Exception {
//
//		BusinessHandler bizHandler = new BusinessHandler() {
//			public void onAuthenticationFailed(SdsUserContextImpl userContext, LoginContext loginContext,
//					LoginResult loginResult, IdentificationHandler idHandler, BusinessHandler bizHandler)
//					throws Exception {
//				onFailExample(userContext, loginContext, loginResult, idHandler, bizHandler);
//			}
//			public void onAuthenticateNewUserLogged(SdsUserContextImpl userContext, LoginContext loginContext,
//					LoginResult loginResult, IdentificationHandler idHandler, BusinessHandler bizHandler)
//					throws Exception {
//				onNewExample(userContext, loginContext, loginResult, idHandler, bizHandler);
//			}
//			public void onAuthenticateUserLogged(SdsUserContextImpl userContext, LoginContext loginContext,
//					LoginResult loginResult, IdentificationHandler idHandler, BusinessHandler bizHandler)
//					throws Exception {
...
//	}
//
//	protected Object onFailExample(SdsUserContextImpl userContext, LoginContext loginContext, LoginResult loginResult,
//			IdentificationHandler idHandler, BusinessHandler bizHandler) {
//		// TODO Auto-generated method stub
//		return null;
//	}
//	protected Object onNewExample(SdsUserContextImpl userContext, LoginContext loginContext, LoginResult loginResult,
//			IdentificationHandler idHandler, BusinessHandler bizHandler) {
//		// 新用户来了,我也不知道该干嘛,所以报错
...
//		return null;
//	}
//	protected Object onSuccessExample(SdsUserContextImpl userContext, LoginContext loginContext, LoginResult loginResult,
//			IdentificationHandler idHandler, BusinessHandler bizHandler) {
//		// 成功了就直接记载第一个userApp
//		SecUser secUser = loginResult.getLoginContext().getLoginTarget().getSecUser();
