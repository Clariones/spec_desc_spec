...
public abstract class BaseIdentificationHandler implements IdentificationHandler{
	...
	protected String getVeriyCodeCacheKey(SdsUserContext userContext, String mobile) {
		return String.format("vcode:%s:%s", mobile, "login");
	}

	protected String getWehatSessionKeyCacheKey(SdsUserContext userContext, String appId, String openId) {
