...
public class UserAppManagerImpl extends CustomSdsCheckerManager implements UserAppManager, BusinessHandler{
	...
	@Override
	public UserAppDAO daoOf(SdsUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws UserAppManagerException{
 	...
 	protected UserApp saveUserApp(SdsUserContext userContext, UserApp userApp, String [] tokensExpr) throws Exception{	
 	...
 	protected UserApp saveUserAppDetail(SdsUserContext userContext, UserApp userApp) throws Exception{	
 	...
 	public UserApp loadUserApp(SdsUserContext userContext, String userAppId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public UserApp searchUserApp(SdsUserContext userContext, String userAppId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected UserApp present(SdsUserContext userContext, UserApp userApp, Map<String, Object> tokens) throws Exception {
 	...
 	public UserApp loadUserAppDetail(SdsUserContext userContext, String userAppId) throws Exception{	
 		UserApp userApp = loadUserApp( userContext, userAppId, allTokens());
 		return present(userContext,userApp, allTokens());
		
 	}
 	
 	public Object view(SdsUserContext userContext, String userAppId) throws Exception{	
 		UserApp userApp = loadUserApp( userContext, userAppId, viewTokens());
 		return present(userContext,userApp, allTokens());
		
 	}
 	protected UserApp saveUserApp(SdsUserContext userContext, UserApp userApp, Map<String,Object>tokens) throws Exception{	
 		return userAppDaoOf(userContext).save(userApp, tokens);
 	}
 	protected UserApp loadUserApp(SdsUserContext userContext, String userAppId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfUserApp(userAppId);
		checkerOf(userContext).throwExceptionIfHasErrors( UserAppManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(SdsUserContext userContext, UserApp userApp, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(SdsUserContext userContext, UserApp userApp, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingUserApp(SdsUserContext userContext,String userAppId, int userAppVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public UserApp clone(SdsUserContext userContext, String fromUserAppId) throws Exception{
	...
	public UserApp internalSaveUserApp(SdsUserContext userContext, UserApp userApp, Map<String,Object> options) throws Exception
	{
	...
	public UserApp updateUserAppProperty(SdsUserContext userContext,String userAppId, int userAppVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingUserApp(userContext, userAppId, userAppVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherSecUser(SdsUserContext userContext, String userAppId, String anotherSecUserId) throws Exception
 	{
	...
	protected void checkParamsForTransferingAnotherSecUserWithLogin(SdsUserContext userContext, String userAppId, String anotherLogin) throws Exception
 	{
 	...
 	public UserApp transferToAnotherSecUserWithLogin(SdsUserContext userContext, String userAppId, String anotherLogin) throws Exception
 	{
	...
	protected void checkParamsForTransferingAnotherSecUserWithEmail(SdsUserContext userContext, String userAppId, String anotherEmail) throws Exception
 	{
 	...
 	public UserApp transferToAnotherSecUserWithEmail(SdsUserContext userContext, String userAppId, String anotherEmail) throws Exception
 	{
	...
	protected void checkParamsForTransferingAnotherSecUserWithMobile(SdsUserContext userContext, String userAppId, String anotherMobile) throws Exception
 	{
 	...
 	public UserApp transferToAnotherSecUserWithMobile(SdsUserContext userContext, String userAppId, String anotherMobile) throws Exception
 	{
 ...
 //--------------------------------------------------------------
	...
	public void delete(SdsUserContext userContext, String userAppId, int userAppVersion) throws Exception {
	...
	public UserApp forgetByAll(SdsUserContext userContext, String userAppId, int userAppVersion) throws Exception {
		return forgetByAllInternal(userContext, userAppId, userAppVersion);
	}
	protected UserApp forgetByAllInternal(SdsUserContext userContext,
			String userAppId, int userAppVersion) throws Exception{
	...
	protected void checkParamsForAddingQuickLink(SdsUserContext userContext, String userAppId, String name, String icon, String imagePath, String linkTarget,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingQuickLinkProperties(SdsUserContext userContext, String userAppId,String id,String name,String icon,String imagePath,String linkTarget,String [] tokensExpr) throws Exception {
	...
	public  UserApp updateQuickLinkProperties(SdsUserContext userContext, String userAppId, String id,String name,String icon,String imagePath,String linkTarget, String [] tokensExpr) throws Exception
	{
	...
	protected QuickLink createQuickLink(SdsUserContext userContext, String name, String icon, String imagePath, String linkTarget) throws Exception{
	...
	protected void checkParamsForRemovingQuickLinkList(SdsUserContext userContext, String userAppId,
	...
	public  UserApp removeQuickLinkList(SdsUserContext userContext, String userAppId,
			String quickLinkIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingQuickLink(SdsUserContext userContext, String userAppId,
	...
	public  UserApp removeQuickLink(SdsUserContext userContext, String userAppId,
		String quickLinkId, int quickLinkVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingQuickLink(SdsUserContext userContext, String userAppId,
		String quickLinkId, int quickLinkVersion,String [] tokensExpr) throws Exception{
	...
	public  UserApp copyQuickLinkFrom(SdsUserContext userContext, String userAppId,
		String quickLinkId, int quickLinkVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingQuickLink(SdsUserContext userContext, String userAppId, String quickLinkId, int quickLinkVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  UserApp updateQuickLink(SdsUserContext userContext, String userAppId, String quickLinkId, int quickLinkVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	protected void checkParamsForAddingListAccess(SdsUserContext userContext, String userAppId, String name, String internalName, boolean readPermission, boolean createPermission, boolean deletePermission, boolean updatePermission, boolean executionPermission,String [] tokensExpr) throws Exception{
	...
	public  UserApp updateListAccessProperties(SdsUserContext userContext, String userAppId, String id,String name,String internalName,boolean readPermission,boolean createPermission,boolean deletePermission,boolean updatePermission,boolean executionPermission, String [] tokensExpr) throws Exception
	{
	...
	protected ListAccess createListAccess(SdsUserContext userContext, String name, String internalName, boolean readPermission, boolean createPermission, boolean deletePermission, boolean updatePermission, boolean executionPermission) throws Exception{
	...
	protected void checkParamsForRemovingListAccessList(SdsUserContext userContext, String userAppId,
	...
	public  UserApp removeListAccessList(SdsUserContext userContext, String userAppId,
			String listAccessIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingListAccess(SdsUserContext userContext, String userAppId,
	...
	public  UserApp removeListAccess(SdsUserContext userContext, String userAppId,
		String listAccessId, int listAccessVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingListAccess(SdsUserContext userContext, String userAppId,
		String listAccessId, int listAccessVersion,String [] tokensExpr) throws Exception{
	...
	public  UserApp copyListAccessFrom(SdsUserContext userContext, String userAppId,
		String listAccessId, int listAccessVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingListAccess(SdsUserContext userContext, String userAppId, String listAccessId, int listAccessVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  UserApp updateListAccess(SdsUserContext userContext, String userAppId, String listAccessId, int listAccessVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(SdsUserContext userContext,SmartList<UserApp> list) throws Exception {
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(SdsUserContext userContext, String userAppId) throws Exception{
	  SerializeScope vscope = SdsViewScope.getInstance().getUserAppDetailScope().clone();
    ...
    String pageTitle = "用户应用程序"+"详情";
		...
		vscope.field("quickLinkListSection", SdsListOfViewScope.getInstance()
		...
		vscope.field("listAccessListSection", SdsListOfViewScope.getInstance()
