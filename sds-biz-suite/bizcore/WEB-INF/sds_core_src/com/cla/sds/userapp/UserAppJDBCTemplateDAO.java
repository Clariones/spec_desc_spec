...
public class UserAppJDBCTemplateDAO extends SdsBaseDAOImpl implements UserAppDAO{
	...
	*/
    ...
    public SmartList<UserApp> requestCandidateUserAppForQuickLink(SdsUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
    ...
    public SmartList<UserApp> requestCandidateUserAppForListAccess(SdsUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
        // NOTE: by default, ignore owner info, just return all by filter key.
		// You need override this method if you have different candidate-logic
		return findAllCandidateByFilter(UserAppTable.COLUMN_TITLE, UserAppTable.COLUMN_SEC_USER, filterKey, pageNo, pageSize, getUserAppMapper());
    }
	...
	public SmartList<QuickLink> loadOurQuickLinkList(SdsUserContext userContext, List<UserApp> us, Map<String,Object> options) throws Exception{
	...
	public SmartList<ListAccess> loadOurListAccessList(SdsUserContext userContext, List<UserApp> us, Map<String,Object> options) throws Exception{
		if (us == null || us.isEmpty()){
			return new SmartList<>();
		}
		Set<String> ids = us.stream().map(it->it.getId()).collect(Collectors.toSet());
