...
public class WechatMiniappIdentityManagerImpl extends CustomSdsCheckerManager implements WechatMiniappIdentityManager, BusinessHandler{
	...
	@Override
	public WechatMiniappIdentityDAO daoOf(SdsUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws WechatMiniappIdentityManagerException{
 	...
 	protected WechatMiniappIdentity saveWechatMiniappIdentity(SdsUserContext userContext, WechatMiniappIdentity wechatMiniappIdentity, String [] tokensExpr) throws Exception{	
 	...
 	protected WechatMiniappIdentity saveWechatMiniappIdentityDetail(SdsUserContext userContext, WechatMiniappIdentity wechatMiniappIdentity) throws Exception{	
 	...
 	public WechatMiniappIdentity loadWechatMiniappIdentity(SdsUserContext userContext, String wechatMiniappIdentityId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public WechatMiniappIdentity searchWechatMiniappIdentity(SdsUserContext userContext, String wechatMiniappIdentityId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected WechatMiniappIdentity present(SdsUserContext userContext, WechatMiniappIdentity wechatMiniappIdentity, Map<String, Object> tokens) throws Exception {
 	...
 	public WechatMiniappIdentity loadWechatMiniappIdentityDetail(SdsUserContext userContext, String wechatMiniappIdentityId) throws Exception{	
 	...
 	public Object view(SdsUserContext userContext, String wechatMiniappIdentityId) throws Exception{	
 		WechatMiniappIdentity wechatMiniappIdentity = loadWechatMiniappIdentity( userContext, wechatMiniappIdentityId, viewTokens());
 		return present(userContext,wechatMiniappIdentity, allTokens());
		
 	}
 	protected WechatMiniappIdentity saveWechatMiniappIdentity(SdsUserContext userContext, WechatMiniappIdentity wechatMiniappIdentity, Map<String,Object>tokens) throws Exception{	
 		return wechatMiniappIdentityDaoOf(userContext).save(wechatMiniappIdentity, tokens);
 	}
 	protected WechatMiniappIdentity loadWechatMiniappIdentity(SdsUserContext userContext, String wechatMiniappIdentityId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfWechatMiniappIdentity(wechatMiniappIdentityId);
		checkerOf(userContext).throwExceptionIfHasErrors( WechatMiniappIdentityManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(SdsUserContext userContext, WechatMiniappIdentity wechatMiniappIdentity, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(SdsUserContext userContext, WechatMiniappIdentity wechatMiniappIdentity, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingWechatMiniappIdentity(SdsUserContext userContext,String wechatMiniappIdentityId, int wechatMiniappIdentityVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public WechatMiniappIdentity clone(SdsUserContext userContext, String fromWechatMiniappIdentityId) throws Exception{
	...
	public WechatMiniappIdentity internalSaveWechatMiniappIdentity(SdsUserContext userContext, WechatMiniappIdentity wechatMiniappIdentity, Map<String,Object> options) throws Exception
	{
	...
	public WechatMiniappIdentity updateWechatMiniappIdentityProperty(SdsUserContext userContext,String wechatMiniappIdentityId, int wechatMiniappIdentityVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingWechatMiniappIdentity(userContext, wechatMiniappIdentityId, wechatMiniappIdentityVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherSecUser(SdsUserContext userContext, String wechatMiniappIdentityId, String anotherSecUserId) throws Exception
 	{
	...
	protected void checkParamsForTransferingAnotherSecUserWithLogin(SdsUserContext userContext, String wechatMiniappIdentityId, String anotherLogin) throws Exception
 	{
 	...
 	public WechatMiniappIdentity transferToAnotherSecUserWithLogin(SdsUserContext userContext, String wechatMiniappIdentityId, String anotherLogin) throws Exception
 	{
	...
	protected void checkParamsForTransferingAnotherSecUserWithEmail(SdsUserContext userContext, String wechatMiniappIdentityId, String anotherEmail) throws Exception
 	{
 	...
 	public WechatMiniappIdentity transferToAnotherSecUserWithEmail(SdsUserContext userContext, String wechatMiniappIdentityId, String anotherEmail) throws Exception
 	{
	...
	protected void checkParamsForTransferingAnotherSecUserWithMobile(SdsUserContext userContext, String wechatMiniappIdentityId, String anotherMobile) throws Exception
 	{
 	...
 	public WechatMiniappIdentity transferToAnotherSecUserWithMobile(SdsUserContext userContext, String wechatMiniappIdentityId, String anotherMobile) throws Exception
 	{
 ...
 //--------------------------------------------------------------
	...
	public void delete(SdsUserContext userContext, String wechatMiniappIdentityId, int wechatMiniappIdentityVersion) throws Exception {
	...
	public WechatMiniappIdentity forgetByAll(SdsUserContext userContext, String wechatMiniappIdentityId, int wechatMiniappIdentityVersion) throws Exception {
		return forgetByAllInternal(userContext, wechatMiniappIdentityId, wechatMiniappIdentityVersion);
	}
	protected WechatMiniappIdentity forgetByAllInternal(SdsUserContext userContext,
			String wechatMiniappIdentityId, int wechatMiniappIdentityVersion) throws Exception{
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(SdsUserContext userContext,SmartList<WechatMiniappIdentity> list) throws Exception {
	...
	public Object listPageBySecUser(SdsUserContext userContext,String secUserId, int start, int count) throws Exception {
		...
		page.setPageTitle("微信Miniapp身份列表");
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(SdsUserContext userContext, String wechatMiniappIdentityId) throws Exception{
	  SerializeScope vscope = SdsViewScope.getInstance().getWechatMiniappIdentityDetailScope().clone();
    ...
    String pageTitle = "微信Miniapp身份"+"详情";
