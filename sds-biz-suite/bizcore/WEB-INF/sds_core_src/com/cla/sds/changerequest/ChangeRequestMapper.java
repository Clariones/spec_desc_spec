...
public class ChangeRequestMapper extends BaseRowMapper<ChangeRequest>{
	...
	protected ChangeRequest internalMapRow(ResultSet rs, int rowNumber) throws SQLException{
		ChangeRequest changeRequest = getChangeRequest();		
 		...
 		setCommited(changeRequest, rs, rowNumber); 		
	...
	protected void setCommited(ChangeRequest changeRequest, ResultSet rs, int rowNumber) throws SQLException{
	
		//there will be issue when the type is double/int/long
		
		Boolean commited = rs.getBoolean(ChangeRequestTable.COLUMN_COMMITED);
