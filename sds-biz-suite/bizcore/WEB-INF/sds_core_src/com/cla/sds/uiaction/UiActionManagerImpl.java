...
public class UiActionManagerImpl extends CustomSdsCheckerManager implements UiActionManager, BusinessHandler{
	...
	@Override
	public UiActionDAO daoOf(SdsUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws UiActionManagerException{
 	...
 	protected UiAction saveUiAction(SdsUserContext userContext, UiAction uiAction, String [] tokensExpr) throws Exception{	
 	...
 	protected UiAction saveUiActionDetail(SdsUserContext userContext, UiAction uiAction) throws Exception{	
 	...
 	public UiAction loadUiAction(SdsUserContext userContext, String uiActionId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public UiAction searchUiAction(SdsUserContext userContext, String uiActionId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected UiAction present(SdsUserContext userContext, UiAction uiAction, Map<String, Object> tokens) throws Exception {
 	...
 	public UiAction loadUiActionDetail(SdsUserContext userContext, String uiActionId) throws Exception{	
 		UiAction uiAction = loadUiAction( userContext, uiActionId, allTokens());
 		return present(userContext,uiAction, allTokens());
		
 	}
 	
 	public Object view(SdsUserContext userContext, String uiActionId) throws Exception{	
 		UiAction uiAction = loadUiAction( userContext, uiActionId, viewTokens());
 		return present(userContext,uiAction, allTokens());
		
 	}
 	protected UiAction saveUiAction(SdsUserContext userContext, UiAction uiAction, Map<String,Object>tokens) throws Exception{	
 		return uiActionDaoOf(userContext).save(uiAction, tokens);
 	}
 	protected UiAction loadUiAction(SdsUserContext userContext, String uiActionId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfUiAction(uiActionId);
		checkerOf(userContext).throwExceptionIfHasErrors( UiActionManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(SdsUserContext userContext, UiAction uiAction, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(SdsUserContext userContext, UiAction uiAction, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingUiAction(SdsUserContext userContext,String uiActionId, int uiActionVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public UiAction clone(SdsUserContext userContext, String fromUiActionId) throws Exception{
	...
	public UiAction internalSaveUiAction(SdsUserContext userContext, UiAction uiAction, Map<String,Object> options) throws Exception
	{
	...
	public UiAction updateUiActionProperty(SdsUserContext userContext,String uiActionId, int uiActionVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingUiAction(userContext, uiActionId, uiActionVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherPage(SdsUserContext userContext, String uiActionId, String anotherPageId) throws Exception
 	{
 ...
 //--------------------------------------------------------------
	...
	public void delete(SdsUserContext userContext, String uiActionId, int uiActionVersion) throws Exception {
	...
	public UiAction forgetByAll(SdsUserContext userContext, String uiActionId, int uiActionVersion) throws Exception {
		return forgetByAllInternal(userContext, uiActionId, uiActionVersion);
	}
	protected UiAction forgetByAllInternal(SdsUserContext userContext,
			String uiActionId, int uiActionVersion) throws Exception{
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(SdsUserContext userContext,SmartList<UiAction> list) throws Exception {
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(SdsUserContext userContext, String uiActionId) throws Exception{
	  SerializeScope vscope = SdsViewScope.getInstance().getUiActionDetailScope().clone();
