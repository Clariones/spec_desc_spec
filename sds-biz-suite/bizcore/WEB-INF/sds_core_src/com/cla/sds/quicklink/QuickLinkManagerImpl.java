...
public class QuickLinkManagerImpl extends CustomSdsCheckerManager implements QuickLinkManager, BusinessHandler{
	...
	@Override
	public QuickLinkDAO daoOf(SdsUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws QuickLinkManagerException{
 	...
 	protected QuickLink saveQuickLink(SdsUserContext userContext, QuickLink quickLink, String [] tokensExpr) throws Exception{	
 	...
 	protected QuickLink saveQuickLinkDetail(SdsUserContext userContext, QuickLink quickLink) throws Exception{	
 	...
 	public QuickLink loadQuickLink(SdsUserContext userContext, String quickLinkId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public QuickLink searchQuickLink(SdsUserContext userContext, String quickLinkId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected QuickLink present(SdsUserContext userContext, QuickLink quickLink, Map<String, Object> tokens) throws Exception {
 	...
 	public QuickLink loadQuickLinkDetail(SdsUserContext userContext, String quickLinkId) throws Exception{	
 		QuickLink quickLink = loadQuickLink( userContext, quickLinkId, allTokens());
 		return present(userContext,quickLink, allTokens());
		
 	}
 	
 	public Object view(SdsUserContext userContext, String quickLinkId) throws Exception{	
 		QuickLink quickLink = loadQuickLink( userContext, quickLinkId, viewTokens());
 		return present(userContext,quickLink, allTokens());
		
 	}
 	protected QuickLink saveQuickLink(SdsUserContext userContext, QuickLink quickLink, Map<String,Object>tokens) throws Exception{	
 		return quickLinkDaoOf(userContext).save(quickLink, tokens);
 	}
 	protected QuickLink loadQuickLink(SdsUserContext userContext, String quickLinkId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfQuickLink(quickLinkId);
		checkerOf(userContext).throwExceptionIfHasErrors( QuickLinkManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(SdsUserContext userContext, QuickLink quickLink, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(SdsUserContext userContext, QuickLink quickLink, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingQuickLink(SdsUserContext userContext,String quickLinkId, int quickLinkVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public QuickLink clone(SdsUserContext userContext, String fromQuickLinkId) throws Exception{
	...
	public QuickLink internalSaveQuickLink(SdsUserContext userContext, QuickLink quickLink, Map<String,Object> options) throws Exception
	{
	...
	public QuickLink updateQuickLinkProperty(SdsUserContext userContext,String quickLinkId, int quickLinkVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingQuickLink(userContext, quickLinkId, quickLinkVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherApp(SdsUserContext userContext, String quickLinkId, String anotherAppId) throws Exception
 	{
 ...
 //--------------------------------------------------------------
	...
	public void delete(SdsUserContext userContext, String quickLinkId, int quickLinkVersion) throws Exception {
	...
	public QuickLink forgetByAll(SdsUserContext userContext, String quickLinkId, int quickLinkVersion) throws Exception {
		return forgetByAllInternal(userContext, quickLinkId, quickLinkVersion);
	}
	protected QuickLink forgetByAllInternal(SdsUserContext userContext,
			String quickLinkId, int quickLinkVersion) throws Exception{
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(SdsUserContext userContext,SmartList<QuickLink> list) throws Exception {
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(SdsUserContext userContext, String quickLinkId) throws Exception{
	  SerializeScope vscope = SdsViewScope.getInstance().getQuickLinkDetailScope().clone();
