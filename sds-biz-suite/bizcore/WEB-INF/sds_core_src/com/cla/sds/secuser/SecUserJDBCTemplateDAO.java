...
public class SecUserJDBCTemplateDAO extends SdsBaseDAOImpl implements SecUserDAO{
	...
	*/
	...
	public SecUser planToRemoveWechatWorkappIdentityListWithCorpId(SecUser secUser, String corpIdId, Map<String,Object> options)throws Exception{
		...
		MultipleAccessKey key = new MultipleAccessKey();
		key.put(WechatWorkappIdentity.SEC_USER_PROPERTY, secUser.getId());
		key.put(WechatWorkappIdentity.CORP_ID_PROPERTY, corpIdId);
		...
		for(WechatWorkappIdentity wechatWorkappIdentityItem: externalWechatWorkappIdentityList){
			wechatWorkappIdentityItem.clearCorpId();
			wechatWorkappIdentityItem.clearSecUser();
	...
	public int countWechatWorkappIdentityListWithCorpId(String secUserId, String corpIdId, Map<String,Object> options)throws Exception{
		...
		MultipleAccessKey key = new MultipleAccessKey();
		key.put(WechatWorkappIdentity.SEC_USER_PROPERTY, secUserId);
		key.put(WechatWorkappIdentity.CORP_ID_PROPERTY, corpIdId);
		
		int count = getWechatWorkappIdentityDAO().countWechatWorkappIdentityWithKey(key, options);
		return count;
	}
	...
	public SecUser planToRemoveWechatWorkappIdentityListWithUserId(SecUser secUser, String userIdId, Map<String,Object> options)throws Exception{
		...
		MultipleAccessKey key = new MultipleAccessKey();
		key.put(WechatWorkappIdentity.SEC_USER_PROPERTY, secUser.getId());
		key.put(WechatWorkappIdentity.USER_ID_PROPERTY, userIdId);
		...
		for(WechatWorkappIdentity wechatWorkappIdentityItem: externalWechatWorkappIdentityList){
			wechatWorkappIdentityItem.clearUserId();
			wechatWorkappIdentityItem.clearSecUser();
	...
	public SecUser planToRemoveWechatMiniappIdentityListWithOpenId(SecUser secUser, String openIdId, Map<String,Object> options)throws Exception{
		...
		MultipleAccessKey key = new MultipleAccessKey();
		key.put(WechatMiniappIdentity.SEC_USER_PROPERTY, secUser.getId());
		key.put(WechatMiniappIdentity.OPEN_ID_PROPERTY, openIdId);
		...
		for(WechatMiniappIdentity wechatMiniappIdentityItem: externalWechatMiniappIdentityList){
			wechatMiniappIdentityItem.clearOpenId();
			wechatMiniappIdentityItem.clearSecUser();
	...
	public int countWechatMiniappIdentityListWithOpenId(String secUserId, String openIdId, Map<String,Object> options)throws Exception{
		...
		int count = getWechatMiniappIdentityDAO().countWechatMiniappIdentityWithKey(key, options);
		return count;
	}
	...
	public SecUser planToRemoveWechatMiniappIdentityListWithAppId(SecUser secUser, String appIdId, Map<String,Object> options)throws Exception{
		...
		MultipleAccessKey key = new MultipleAccessKey();
		key.put(WechatMiniappIdentity.SEC_USER_PROPERTY, secUser.getId());
		key.put(WechatMiniappIdentity.APP_ID_PROPERTY, appIdId);
		...
		for(WechatMiniappIdentity wechatMiniappIdentityItem: externalWechatMiniappIdentityList){
			wechatMiniappIdentityItem.clearAppId();
			wechatMiniappIdentityItem.clearSecUser();
