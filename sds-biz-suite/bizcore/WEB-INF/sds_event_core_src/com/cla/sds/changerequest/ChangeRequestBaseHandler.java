...
public class ChangeRequestBaseHandler extends CustomSdsCheckerManager{
	
	private static final String SUB_EVENT_NAMES[]={"eventUpdateProfileProcessor"};
	
	public ChangeRequest handle(SdsUserContext userContext, ChangeRequest request) throws Exception {
	...
	protected void handleByChainNode(SdsUserContext userContext, ChangeRequest request, String beanName){
