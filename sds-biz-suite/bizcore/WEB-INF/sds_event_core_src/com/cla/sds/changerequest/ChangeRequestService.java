...
public class ChangeRequestService extends CustomSdsCheckerManager{
	
	
	
	public ChangeRequest save(SdsUserContext userContext, ChangeRequest request) throws Exception {
	...
	public ChangeRequest process(SdsUserContext userContext, ChangeRequest request) throws Exception {
	...
	protected void saveChangeRequest(SdsUserContext userContext,ChangeRequest request) throws Exception{
		this.changeRequestManagerOf(userContext).internalSaveChangeRequest(userContext, request);
	}
	
	protected String calcBeanNameFor(SdsUserContext userContext,String type) {
	...
	protected ChangeRequestBaseHandler calcHandlerFor(SdsUserContext userContext,ChangeRequest request){
		String type = request.getRequestType().getId();
		if(type == null) {
