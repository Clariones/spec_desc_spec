...
public class SdsBizUserContextImpl extends SdsUserContextImpl{
	...
	protected BaseSdsFormProcessor inputFormData;
	protected BaseSdsFormProcessor outputFormData;
	...
	public String getPostMd5Key(SdsBizUserContextImpl ctx) {
	...
	public BaseSdsFormProcessor getInputFormData() {
		return inputFormData;
	}
	public void setInputFormData(BaseSdsFormProcessor inputFormData) {
		this.inputFormData = inputFormData;
	}
	public BaseSdsFormProcessor getOutputFormData() {
		return outputFormData;
	}
	public void setOutputFormData(BaseSdsFormProcessor outputFormData) {
