...
import com.cla.sds.LoginForm;
import com.cla.sds.BaseEntity;
import com.cla.sds.CommonError;
import com.cla.sds.DAOGroup;
import com.cla.sds.ManagerGroup;

import com.cla.sds.UserContextImpl;
import com.cla.sds.userapp.UserApp;
import com.cla.sds.SdsUserContext;
import com.cla.sds.userapp.*;
import com.cla.sds.listaccess.*;
import com.cla.sds.SdsObjectChecker;
...
public class CustomSecUserManagerImpl extends SecUserManagerImpl implements
   ...
   public void setBlockChainAdvancer(BlockChainAdvancer pBlockChainAdvancer){
    ...
    public String confirmSession(SdsUserContext userContext){
    ...
    public Object resetPassword(SdsUserContext userContext, String mobile, int verifycationCode, String newPassword) {
    ...
    public Object resetPasswordWithoutLogin(SdsUserContext userContext, String loginType, String loginKey, int verifycationCode, String newPassword) {
        SecUser user;
        try {
    ...
    public Object selectApp(SdsUserContext userContext,
    ...
    public SecUser manage(SdsUserContext userContext) throws Exception{
        SecUser user = cachedUser(userContext);
    ...
    protected SecUser cachedUser(SdsUserContext userContext)
    {
        return (SecUser)userContext.getCachedObject(this.getUserKey(userContext), SecUser.class);
    }

    public SecUser getCachedSecUser(SdsUserContext userContext) {
    ...
    protected Object gotoApp(SdsUserContext userContext, UserApp app) throws Exception {
    ...
    public String getVerificationCode(SdsUserContext userContext,String mobile){
    ...
    protected void sendVerificationCode(SdsUserContext userContext, String mobile,String code) throws Exception{
    ...
    protected int getRandomVerificationCode(SdsUserContext userContex, int length){
    ...
    protected String getBeanName(SdsUserContext userContext, UserApp app){
    ...
    protected String getTargetObjectId(SdsUserContext userContext, UserApp app){

        return  app.getObjectId();

    }
    protected String getServiceType(SdsUserContext userContext, UserApp app){

        return app.getObjectType();
    }
    protected String getMethodName(SdsUserContext userContext, UserApp app){
    ...
    public Object home(SdsUserContext userContext) {
    ...
    public Object loginWithEmail(SdsUserContext userContext, String email,
            Password password) {

        return loginInternal(userContext,"email",email, password);

    }
    public Object login(SdsUserContext userContext, String email,
            Password password) {
    ...
    public Object loginWithLogin(SdsUserContext userContext, String email,
            Password password) {

        return loginInternal(userContext,"login",email, password);

    }
    public Object loginWithMobile(SdsUserContext userContext, String email,
            Password password) {
        return loginInternal(userContext,"mobile",email, password);

    }
    protected SecUser loadUserWith(SdsUserContext userContext, String type, String userId) throws Exception{
    ...
    protected Object loginInternal(SdsUserContext userContext, String type, String userId,
            Password password) {
     ...
     */
    protected Object loginTheSecUserInternal(SdsUserContext userContext, SecUser user, String loginComments) throws Exception {
		...
		iamService.onLoginSecUserInternalSuccess((SdsUserContextImpl) userContext, user);
    ...
    public Object showlogin(SdsUserContext userContext) {
    ...
    protected LoginForm showSessionExpired(SdsUserContext userContext) {
    ...
    public BaseUserContext loadUserConext(HttpServletRequest request)
        ...
        SdsUserContextImpl uc = createNewConext(path);
        init(uc, request);
        return uc;
    }
    ...
    protected SdsObjectChecker checker;
    public SdsObjectChecker getChecker(){
        return checker;
    }

    public void setChecker(SdsObjectChecker checker){
    ...
    protected void init(UserContextImpl userContext, HttpServletRequest request) {
        ...
        userContext.setChecker((SdsObjectChecker)beanFactory.getBean(getCheckerBeanName()));
    ...
    protected SdsUserContextImpl createNewConext(String path) {

        return new CustomSdsUserContextImpl();
    ...
    public Object checkOtherLogin(SdsUserContext userContext) throws Exception {
	...
	protected void checkUserHasManagementAccess(SdsUserContext userContext, String objectType, String objectId)
	...
	public UserApp updateAppPermission(SdsUserContext userContext, String secUserId, String userAppId, int version,
	...
	public UserApp updateListAccess(SdsUserContext userContext, String secUserId, String userAppId, String displayName,
	...
	public UserApp loadUserAppWithUser(SdsUserContext userContext, String secUserId, String objectType,
    ...
    public Object changeCurUserPassword(SdsUserContext userContext, String currentPassword, String newPassword)
			throws Exception {
	...
	public String testIfHasManagementAccess(SdsUserContext userContext,String objectType,String objectId) {
		try {
			this.checkUserHasManagementAccess(userContext, objectType, objectId);
			return "OK";
		}catch(Exception e){
    ...
    public Map<String, Object> testoss(SdsUserContext userContext) throws SecUserManagerException {
