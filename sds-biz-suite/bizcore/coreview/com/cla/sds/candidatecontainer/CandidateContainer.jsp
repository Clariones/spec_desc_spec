<%@ page import='java.util.*,com.cla.sds.*,com.cla.sds.candidatecontainer.CandidateContainer'%>
...
<sky:include page="com/cla/sds/candidatecontainer/CandidateContainer$Summary.jsp" />
		...
		<div id="candidateElementList" class="tab-pane fade sublist" refer-name="container">
			<sky:include page="com/cla/sds/candidateelement/CandidateElement$List.jsp"
					referName="container"/>
		</div>
	</c:if>
