<%@ page import='java.util.*,com.cla.sds.*,com.cla.sds.platform.Platform'%>
...
<div class="row">
	...
	<% Platform result = (Platform)request.getAttribute("result");  %>
			<li><a data-toggle="tab" href="#companyList" class="disabled"> ${userContext.localeMap['company']}</a></li>
...
<sky:include page="com/cla/sds/platform/Platform$Summary.jsp" />
		...
		<c:if test='${not empty userContext.accessTokens["companyList"] or ignoreListAccessControl}'>
		<c:set var="companyList" value="${result.companyList}" scope="request"/>
		<c:set var="companyListName" value="companyList" scope="request"/>
		<div id="companyList" class="tab-pane fade sublist" refer-name="platform">
			<sky:include page="com/cla/sds/company/Company$List.jsp"
					referName="platform"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["changeRequestTypeList"] or ignoreListAccessControl}'>
		...
		<div id="changeRequestTypeList" class="tab-pane fade sublist" refer-name="platform">
			<sky:include page="com/cla/sds/changerequesttype/ChangeRequestType$List.jsp"
					referName="platform"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["changeRequestList"] or ignoreListAccessControl}'>
		...
		<div id="changeRequestList" class="tab-pane fade sublist" refer-name="platform">
			<sky:include page="com/cla/sds/changerequest/ChangeRequest$List.jsp"
					referName="platform"/>
		</div>
	</c:if>
