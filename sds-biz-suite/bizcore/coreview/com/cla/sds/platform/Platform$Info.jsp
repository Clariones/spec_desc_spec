...
<li><span>${userContext.localeMap['platform.create_time']}</span> <fmt:formatDate pattern="yyyy-MM-dd" value="${platform.createTime}" /></li>
<li><span>${userContext.localeMap['platform.last_update_time']}</span> <fmt:formatDate pattern="yyyy-MM-dd" value="${platform.lastUpdateTime}" /></li>
