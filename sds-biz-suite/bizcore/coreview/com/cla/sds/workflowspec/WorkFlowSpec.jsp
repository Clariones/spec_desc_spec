<%@ page import='java.util.*,com.cla.sds.*,com.cla.sds.workflowspec.WorkFlowSpec'%>
...
<c:set var="ownerBeanName" value="workFlowSpec" scope="request"/>
<c:set var="ownerClassName" value="WorkFlowSpec" scope="request"/>
...
<div class="row">
	...
	<% WorkFlowSpec result = (WorkFlowSpec)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="workFlowSpec" value="${ result}" scope="request" />
<sky:include page="com/cla/sds/workflowspec/WorkFlowSpec$Summary.jsp" />
