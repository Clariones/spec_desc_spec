<%@ page import='java.util.*,com.cla.sds.*,com.cla.sds.keypairidentity.KeypairIdentity'%>
...
<sky:include page="com/cla/sds/keypairidentity/KeypairIdentity$Summary.jsp" />
...
<sky:include page="com/cla/sds/publickeytype/PublicKeyType$Info.jsp" />
