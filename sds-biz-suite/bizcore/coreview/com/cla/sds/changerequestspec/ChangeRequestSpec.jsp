<%@ page import='java.util.*,com.cla.sds.*,com.cla.sds.changerequestspec.ChangeRequestSpec'%>
...
<c:set var="ownerBeanName" value="changeRequestSpec" scope="request"/>
<c:set var="ownerClassName" value="ChangeRequestSpec" scope="request"/>
...
<div class="row">
	...
	<% ChangeRequestSpec result = (ChangeRequestSpec)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="changeRequestSpec" value="${ result}" scope="request" />
<sky:include page="com/cla/sds/changerequestspec/ChangeRequestSpec$Summary.jsp" />
	...
	<div class="row">
<c:set var="user" value="${ result.owner}" scope="request" />
<c:set var="referName" value="(owner)" scope="request" />
<sky:include page="com/cla/sds/user/User$Info.jsp" />

<c:set var="project" value="${ result.project}" scope="request" />
<c:set var="referName" value="" scope="request" />
<sky:include page="com/cla/sds/project/Project$Info.jsp" />
