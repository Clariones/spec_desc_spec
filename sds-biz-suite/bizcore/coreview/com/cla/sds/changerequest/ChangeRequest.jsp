<%@ page import='java.util.*,com.cla.sds.*,com.cla.sds.changerequest.ChangeRequest'%>
...
<div class="row">
	...
	<% ChangeRequest result = (ChangeRequest)request.getAttribute("result");  %>
			<li><a data-toggle="tab" href="#eventUpdateProfileList" class="disabled"> ${userContext.localeMap['event_update_profile']}</a></li>
...
<sky:include page="com/cla/sds/changerequest/ChangeRequest$Summary.jsp" />
...
<sky:include page="com/cla/sds/changerequesttype/ChangeRequestType$Info.jsp" />
...
<sky:include page="com/cla/sds/platform/Platform$Info.jsp" />
		...
		<c:if test='${not empty userContext.accessTokens["eventUpdateProfileList"] or ignoreListAccessControl}'>
		<c:set var="eventUpdateProfileList" value="${result.eventUpdateProfileList}" scope="request"/>
		<c:set var="eventUpdateProfileListName" value="eventUpdateProfileList" scope="request"/>
		<div id="eventUpdateProfileList" class="tab-pane fade sublist" refer-name="change_request">
			<sky:include page="com/cla/sds/eventupdateprofile/EventUpdateProfile$List.jsp"
