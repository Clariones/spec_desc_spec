<%@ page import='java.util.*,com.cla.sds.*,com.cla.sds.userproject.UserProject'%>
...
<c:set var="ownerBeanName" value="userProject" scope="request"/>
<c:set var="ownerClassName" value="UserProject" scope="request"/>
...
<div class="row">
	...
	<% UserProject result = (UserProject)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="userProject" value="${ result}" scope="request" />
<sky:include page="com/cla/sds/userproject/UserProject$Summary.jsp" />
