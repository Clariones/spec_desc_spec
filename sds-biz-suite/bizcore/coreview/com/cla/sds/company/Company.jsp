<%@ page import='java.util.*,com.cla.sds.*,com.cla.sds.company.Company'%>
...
<c:set var="ownerBeanName" value="company" scope="request"/>
<c:set var="ownerClassName" value="Company" scope="request"/>
...
<div class="row">
	...
	<% Company result = (Company)request.getAttribute("result");  %>
			<li><a data-toggle="tab" href="#userList" class="disabled"> ${userContext.localeMap['user']}</a></li>
			<li><a data-toggle="tab" href="#projectList" class="disabled"> ${userContext.localeMap['project']}</a></li>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="company" value="${ result}" scope="request" />
<sky:include page="com/cla/sds/company/Company$Summary.jsp" />
...
<sky:include page="com/cla/sds/platform/Platform$Info.jsp" />
		...
		<div id="userList" class="tab-pane fade sublist" refer-name="company">
			<sky:include page="com/cla/sds/user/User$List.jsp"
					referName="company"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["projectList"] or ignoreListAccessControl}'>
		<c:set var="projectList" value="${result.projectList}" scope="request"/>
		<c:set var="projectListName" value="projectList" scope="request"/>
		<div id="projectList" class="tab-pane fade sublist" refer-name="company">
			<sky:include page="com/cla/sds/project/Project$List.jsp"
					referName="company"/>
		</div>
	</c:if>
