<%@ page import='java.util.*,com.cla.sds.*,com.cla.sds.wechatworkappidentity.WechatWorkappIdentity'%>
...
<sky:include page="com/cla/sds/wechatworkappidentity/WechatWorkappIdentity$Summary.jsp" />
