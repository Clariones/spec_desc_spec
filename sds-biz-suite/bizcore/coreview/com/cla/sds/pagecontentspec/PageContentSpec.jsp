<%@ page import='java.util.*,com.cla.sds.*,com.cla.sds.pagecontentspec.PageContentSpec'%>
...
<c:set var="ownerBeanName" value="pageContentSpec" scope="request"/>
<c:set var="ownerClassName" value="PageContentSpec" scope="request"/>
...
<div class="row">
	...
	<% PageContentSpec result = (PageContentSpec)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="pageContentSpec" value="${ result}" scope="request" />
<sky:include page="com/cla/sds/pagecontentspec/PageContentSpec$Summary.jsp" />
