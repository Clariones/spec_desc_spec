<%@ page import='java.util.*,com.cla.sds.*,com.cla.sds.userapp.UserApp'%>
...
<sky:include page="com/cla/sds/userapp/UserApp$Summary.jsp" />
...
<sky:include page="com/cla/sds/secuser/SecUser$Info.jsp" />
		...
		<div id="quickLinkList" class="tab-pane fade sublist" refer-name="app">
			<sky:include page="com/cla/sds/quicklink/QuickLink$List.jsp"
					referName="app"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["listAccessList"] or ignoreListAccessControl}'>
		...
		<div id="listAccessList" class="tab-pane fade sublist" refer-name="app">
			<sky:include page="com/cla/sds/listaccess/ListAccess$List.jsp"
					referName="app"/>
		</div>
	</c:if>
