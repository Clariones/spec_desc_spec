<%@ page import='java.util.*,com.cla.sds.*,com.cla.sds.mobileapp.MobileApp'%>
...
<sky:include page="com/cla/sds/mobileapp/MobileApp$Summary.jsp" />
		...
		<div id="pageList" class="tab-pane fade sublist" refer-name="mobile_app">
			<sky:include page="com/cla/sds/page/Page$List.jsp"
					referName="mobileApp"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["pageTypeList"] or ignoreListAccessControl}'>
		...
		<div id="pageTypeList" class="tab-pane fade sublist" refer-name="mobile_app">
			<sky:include page="com/cla/sds/pagetype/PageType$List.jsp"
					referName="mobileApp"/>
		</div>
	</c:if>
