<%@ page import='java.util.*,com.cla.sds.*,com.cla.sds.uiaction.UiAction'%>
...
<sky:include page="com/cla/sds/uiaction/UiAction$Summary.jsp" />
...
<sky:include page="com/cla/sds/page/Page$Info.jsp" />
