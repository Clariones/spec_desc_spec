<%@ page import='java.util.*,com.cla.sds.*,com.cla.sds.userdomain.UserDomain'%>
...
<sky:include page="com/cla/sds/userdomain/UserDomain$Summary.jsp" />
		...
		<div id="userWhiteListList" class="tab-pane fade sublist" refer-name="domain">
			<sky:include page="com/cla/sds/userwhitelist/UserWhiteList$List.jsp"
					referName="domain"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["secUserList"] or ignoreListAccessControl}'>
		...
		<div id="secUserList" class="tab-pane fade sublist" refer-name="domain">
			<sky:include page="com/cla/sds/secuser/SecUser$List.jsp"
					referName="domain"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["publicKeyTypeList"] or ignoreListAccessControl}'>
		...
		<div id="publicKeyTypeList" class="tab-pane fade sublist" refer-name="domain">
			<sky:include page="com/cla/sds/publickeytype/PublicKeyType$List.jsp"
					referName="domain"/>
		</div>
	</c:if>
