<%@ page import='java.util.*,com.cla.sds.*,com.cla.sds.secuser.SecUser'%>
...
<sky:include page="com/cla/sds/secuser/SecUser$Summary.jsp" />
...
<sky:include page="com/cla/sds/userdomain/UserDomain$Info.jsp" />
		...
		<div id="userAppList" class="tab-pane fade sublist" refer-name="sec_user">
			<sky:include page="com/cla/sds/userapp/UserApp$List.jsp"
					referName="secUser"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["loginHistoryList"] or ignoreListAccessControl}'>
		...
		<div id="loginHistoryList" class="tab-pane fade sublist" refer-name="sec_user">
			<sky:include page="com/cla/sds/loginhistory/LoginHistory$List.jsp"
					referName="secUser"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["wechatWorkappIdentityList"] or ignoreListAccessControl}'>
		...
		<div id="wechatWorkappIdentityList" class="tab-pane fade sublist" refer-name="sec_user">
			<sky:include page="com/cla/sds/wechatworkappidentity/WechatWorkappIdentity$List.jsp"
					referName="secUser"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["wechatMiniappIdentityList"] or ignoreListAccessControl}'>
		...
		<div id="wechatMiniappIdentityList" class="tab-pane fade sublist" refer-name="sec_user">
			<sky:include page="com/cla/sds/wechatminiappidentity/WechatMiniappIdentity$List.jsp"
					referName="secUser"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["keypairIdentityList"] or ignoreListAccessControl}'>
		...
		<div id="keypairIdentityList" class="tab-pane fade sublist" refer-name="sec_user">
			<sky:include page="com/cla/sds/keypairidentity/KeypairIdentity$List.jsp"
					referName="secUser"/>
		</div>
	</c:if>
