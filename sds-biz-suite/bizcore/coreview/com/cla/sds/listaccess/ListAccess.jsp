<%@ page import='java.util.*,com.cla.sds.*,com.cla.sds.listaccess.ListAccess'%>
...
<sky:include page="com/cla/sds/listaccess/ListAccess$Summary.jsp" />
...
<sky:include page="com/cla/sds/userapp/UserApp$Info.jsp" />
