<%@ page import='java.util.*,com.cla.sds.*,com.cla.sds.pageflowspec.PageFlowSpec'%>
...
<c:set var="ownerBeanName" value="pageFlowSpec" scope="request"/>
<c:set var="ownerClassName" value="PageFlowSpec" scope="request"/>
...
<div class="row">
	...
	<% PageFlowSpec result = (PageFlowSpec)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="pageFlowSpec" value="${ result}" scope="request" />
<sky:include page="com/cla/sds/pageflowspec/PageFlowSpec$Summary.jsp" />
