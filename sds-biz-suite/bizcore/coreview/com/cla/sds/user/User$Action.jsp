...
<li><span>${userContext.localeMap['user.join_time']}</span> <fmt:formatDate pattern="yyyy-MM-dd" value="${user.joinTime}" /></li>
<li><span>${userContext.localeMap['user.title']}</span> ${user.title}</li>
