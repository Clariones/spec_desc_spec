...
<div class="col-xs-12 col-md-3 summary-section">
<span class="summary-label">${userContext.localeMap['user.join_time']}</span>
<span ><fmt:formatDate pattern="yyyy-MM-dd" value="${result.joinTime}" /></span>
</div>
<div class="col-xs-12 col-md-3 summary-section">
<span class="summary-label">${userContext.localeMap['user.title']}</span>
