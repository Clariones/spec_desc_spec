<%@ page import='java.util.*,com.cla.sds.*,com.cla.sds.eventupdateprofile.EventUpdateProfile'%>
...
<c:set var="ownerBeanName" value="eventUpdateProfile" scope="request"/>
<c:set var="ownerClassName" value="EventUpdateProfile" scope="request"/>
...
<div class="row">
	...
	<% EventUpdateProfile result = (EventUpdateProfile)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="eventUpdateProfile" value="${ result}" scope="request" />
<sky:include page="com/cla/sds/eventupdateprofile/EventUpdateProfile$Summary.jsp" />
...
<sky:include page="com/cla/sds/changerequest/ChangeRequest$Info.jsp" />
