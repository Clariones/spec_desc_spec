<%@ page import='java.util.*,com.cla.sds.*,com.cla.sds.candidateelement.CandidateElement'%>
...
<sky:include page="com/cla/sds/candidateelement/CandidateElement$Summary.jsp" />
...
<sky:include page="com/cla/sds/candidatecontainer/CandidateContainer$Info.jsp" />
