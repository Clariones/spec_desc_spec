<%@ page import='java.util.*,com.cla.sds.*,com.cla.sds.wechatminiappidentity.WechatMiniappIdentity'%>
...
<sky:include page="com/cla/sds/wechatminiappidentity/WechatMiniappIdentity$Summary.jsp" />
